...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/purchase_recieved_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/purchase_recieved_body.php')?>
        <!-- content page ends -->
    ...
    <!--<script src="../httpdocs/user_js/purchase_recieved_v1.js"></script>-->
    <script src="../httpdocs/user_js/purchase_recieved_updated.js"></script>
