                ...
                <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
                    <div class="media w-100 ">
                        ...
                        <div class="media-body">
                            <h5 class="time-title mb-0  text-white">New Companies/Clients</h5>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <!--    <a href="" class="dropdown-item">New</a>-->
                                <button  class="btn btn-sm btn-outline-light" onclick="openNavR()" id="btn_view_list_of_companies">List of Companies</button>
                        ...
                        <div class="col-md-10 ">
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6">
                                    <label>Company/Client Name <st style="color:red">*</st></label>
                            ...
                            <!--<div class="form-group row">-->
                                ...
                                <!--<div class="col-lg-4 col-md-6">-->
                                <!--    <label>Email <st style="color:red">*</st></label>-->
                                <!--    <input type="email" id="txt_contact_email" class="form-control" placeholder="">-->
                                <!--</div>-->
                                <!--<div class="col-lg-4 col-md-6">-->
                                <!--    <label>Phone Number <st style="color:red">*</st></label>-->
                                <!--    <input type="text" id="txt_contact_phone" class="form-control" placeholder="">-->
...
<div id="mySidenavR" class="sidenavR " height="100%" style="background-color:white;padding-top:70px;box-shadow: -10px 0px 10px #e3e3e3;">
                        ...
                        <div class="card-header">
                                ...
                                <div class="row ">
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <h5 class="mb-0">List of Companies</h5>
                                    </div>
 ...
 <div id="view_project_modal" class="modal modal-fixed-footer md" style="width: 100%;height: 100%;">
   ...
   <div class="modal-head" style="padding:20px;padding-left:30px;background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);height:70px; ">
	   ...
	   <div class="row" >
           <div class="input-field col lg8 m8 s12" style="padding-bottom:20px;"> 
	        <h6 style="color:white;">Projects of&nbsp;&nbsp;&nbsp;<span id="company_name"></span></h6> 
	        </div>
    ...
    <div class="modal-content" style = "height: 100%;">
        <div class="row row-cols-1 row-cols-sm-2 g-0">
			<div class="col-lg-4 col-xl-4">
				<button type="button" id="btn_view_project_tbl" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom p-3">
					<div style="width:100%;">
						<div class="card card-body" style="margin-bottom: 0px;">
							<div class="d-flex align-items-center">
								
								<div class="flex-fill text-end">
								<h4 class="mb-0" id="txt_project"></h4>
			...
			<div class="col-lg-4 col-xl-4">
				<button type="button" id="btn_view_quotation_tbl" class="dropdown-item text-wrap h-100 align-items-start border-bottom p-3">
					<div style="width:100%;">
						<div class="card card-body" style="margin-bottom: 0px;">
							<div class="d-flex align-items-center">
								
								<div class="flex-fill text-end">
								 <h4 class="mb-0" id="txt_quotation"></h4>
									<span class="text-muted">Number of Quotations</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-4 col-xl-4">
				<button type="button" id="btn_approved_quotation_tbl" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom border-bottom-sm-0 rounded-bottom-start p-3">
					<div style="width:100%;">
						<div class="card card-body" style="margin-bottom: 0px;">
							<div class="d-flex align-items-center">
								<div class="flex-fill text-end">
								<h4 class="mb-0" id="txt_app_quotation"></h4>
									<span class="text-muted">Approved Quotations</span>
								</div>
							</div>
						</div>
					</div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px" id="myDiv">
                    <div class="card rounded-0 border-0 mb-12">
                        <div class="card-header">
                                ...
                                <div class="row ">
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <h5 class="mb-0">List of Quotations - Project Wise</h5>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-6" style="text-align:right">
                        ...
                        <div class="card-body ">
                        <!--Table-->
                            <table class="table" id="list_of_project"  style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
                                    <tr >
                                        <th style="width:5px">Details</th>
                                        <th>Sl No </th>
