...
?>
 <select  id="select_department" name="select_department" class="chosen_select form-control form-control-sm" data-live-search="true" tabindex="-1"  aria-hidden="true" multiple>
...
?>
  <option value="<?PHP echo $row['ids']; ?>" >  <?PHP echo $row['department_name'] ?></option>
