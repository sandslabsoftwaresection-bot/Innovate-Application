            ...
            <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
				<div class="media w-100 ">
					...
					<div class="media-body">
						<h5 class="time-title mb-0  text-white">New Division / Department</h5>
					</div>   
					<div class="dropdown " style="padding-left:50px;">
						...
						<div class="dropdown-menu " aria-labelledby="dropdownMenuButton" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -101px, 0px); top: 0px; left: 0px; will-change: transform;">
							<a class="dropdown-item ladda-button" href="#" onclick="openNavR()" id="view_division_list" data-style="expand-right"><span class="ladda-label">List of Division</span><span class="ladda-spinner"></span></a>
							<a class="dropdown-item" href="#" onclick="openNavRCancel()" id="view_department_list">List of Department</a>
						</div>
					</div>
				</div>
            </div>
                            ...
                            <div class="card-body ">
									...
									<!--<div class="row" >-->
										...
										<div class="col-sm-12 col-md-12 col-lg-12">
												<input type="text" class="form-control form-control-sm" id="txt_division"> 
										</div>
										<div class="col-sm-12 col-md-12 col-lg-12" style="text-align:right">
                                                <button class="btn btn-primary" id="btn_add_division"> <i class="material-icons">list</i>Add</button>
                                                <button style="display:none;" class="btn btn-warning" id="btn_edit_division" style="color:white"> <i class="material-icons">edit</i>Update</button>
                            ...
                            <div class="card-body ">
    							<div class="form-group custom-font">
    									<!--<div class="row" >-->
    										...
    										<div class="col-sm-12 col-md-12 col-lg-12">
    											<input type="text" class="form-control form-control-sm" id="txt_department"> 
    										     
    										</div>
    										<div class="col-sm-12 col-md-12 col-lg-12" style="text-align:right">
                                                <button class="btn btn-primary" id="btn_add_department"> <i class="material-icons">list</i>Add</button>
                                                <button style="display:none;" class="btn btn-warning" id="btn_edit_department" style="color:white"> <i class="material-icons">edit</i>Update</button>
            ...
            <div class="card rounded-0 border-0 mb-12">
                <div class="card-header">
					<div class="row">
						<div class="col-sm-10 col-md-10 col-lg-10">
							<h5 class="mb-0">List of Divisions</h5>
							<input type="hidden" class="form-control form-control-sm" id="division_id">
						</div>
                ...
                <div class="card-body " style="overflow:auto;">
                    <div class="row ">
                        ...
                        <!--Table-->
						    <table class="table " id="list_of_division" class="custom-font" style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
            ...
            <div class="card rounded-0 border-0 mb-12">
                <div class="card-header">
					<div class="row ">
						<div class="col-sm-10 col-md-10 col-lg-10">
							...
							<input type="hidden" class="form-control form-control-sm" id="department_id">
						</div>
						<div class="col-sm-2 col-md-2 col-lg-2" style="text-align:right">  
							<!--<button type="button" class="mb-2 btn btn-sm btn-primary" onclick="closeNavR()">X</button>-->
                ...
                <div class="card-body " style="overflow:auto;">
                    <div class="row">
                        ...
                        <!--Table-->
                             <table class="table " id="list_of_departments" class="custom-font" style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
                                    <tr class="custom-font">
                                        <th>ID </th>
