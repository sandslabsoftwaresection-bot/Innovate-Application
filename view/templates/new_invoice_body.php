...
<!-- content page -->
        <div class="container mt-2 main-container" >
                ...
                <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
                    <div class="media w-100 ">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0  text-white">Invoice #: <inno id="invoice_no_head"></inno><!--<span class="status bg-success"> </span>--></p>
                        </div>
                                ...
                                <div class="card rounded-0 border-0 mb-5">
                                    ...
                                    <div class="card-body ">
                                         ...
                                         <div class="form-group custom-font">
                                            <div class="row" >
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-8">
														...
														<input type="text" class="form-control form-control-sm" value=" " style="color:black;font-weight:700" disabled id="txt_real_invoice_no">														
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group custom-font">
                                        ...
                                        <div class="form-group custom-font">
										 ...
										 <div class="form-group custom-font">
                                                   ...
                                                   <div class="row" >
                                                             ...
                                                             <div class="col-sm-6 col-md-6 col-lg-4">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="option2" class="custom-control-input" id="customradio3" value="3" checked="">
                                                                    <label class="custom-control-label" for="customradio3">Quotation</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-md-6 col-lg-4">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="option2" class="custom-control-input" id="customradio4" value="4" checked="">
                                                                    <label class="custom-control-label" for="customradio4">Intern Payment</label>
                                                                </div>
                                                            </div>
                                                 </div>      
                                      ...
                                      <div class="form-group custom-font">
										...
										<div class="form-group custom-font" id="div_intern">
											<div class="row" >
                                                <div class="col-sm-12 col-md-6 col-lg-4">
                                                        <label>Intern Application Ref</label>
                                                </div>
                                                <div class="col-sm-12 col-md-6 col-lg-8" id="div_select_intern_combo">
                                                     <select class="form-control form-control-sm">
                                                        <option>--Select Intern Application--</option>
                                                     </select>
                                                   
                                                </div>
											</div>	
										</div>
										<div class="form-group custom-font" id="div_cust_intrn_no">
                                            <div class="row" >
                                                <div class="col-sm-12 col-md-6 col-lg-4">
                                                        <label>Customer Intern No</label>
                                                </div>
                                                <div style="display: flex;" class="col-sm-12 col-md-6 col-lg-8">
                                                        <input style="width: 80%;"
														type="text" class="form-control form-control-sm" id="txt_cust_intern_no"> 
														<button style="width: 20%;margin-left: 5px; height:30px" class="btn btn-info" id="btn_view_document">View</button>
                                                </div>
												
                                            </div>
                                        </div>
																														<div class="form-group custom-font"id=	"div_upload">
                                            <div class="row" >
                                                <div class="col-sm-12 col-md-6 col-lg-4">
                                                        <label>Upload Document</label>
                                                </div>
                                                <div class="col-sm-12 col-md-6 col-lg-8">
												<input type="file" id="cust_file">
         ...
         <div class="container mt-1 main-container">
                               ...
                               <!-- <div class="col-sm-12 col-md-6 col-lg-2 custom-font"> -->
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-2 custom-font" style="display:none">
                                        <label id="">Discount Amount </label>
                                         <div class="input-group mb-1" id="">
                                                            <div class="input-group-prepend" id="div_discount_amount_type">
                                                                <select >
                                                                    <option>%</option>
                                                                    <option>BD</option>
                                                                </select>
                                                            </div>
                                        <input type="text" class="form-control form-control-sm" style="text-align:right;" id="txt_discount_amount_qt" placeholder="0.000"> 
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 custom-font">
                                        ...
                                        <input type="text" class="form-control form-control-sm" style="text-align:right;" id="txt_invoice_received_amount" placeholder="0.000" disabled> 
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-2 custom-font"  >
                                        ...
                                        <div class="input-group mb-1" id="div_discount">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" style="text-align:right;" id="txt_invoice_retention_percentage" placeholder="0.000" disabled> 
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-2 custom-font" id="discount_div" style="display:none">
                                        <label id="">Discount Amount </label>
                                         <div class="input-group mb-1" id="">
                                                            <div class="input-group-prepend">
                                                                <select >
                                        ...
                                        <input type="text" class="form-control form-control-sm" style="text-align:right;" id="txt_final_discount_amount" placeholder="0.000"> 
                                        <input type="hidden" class="form-control form-control-sm" style="color:black;font-weight:700;text-align:right; " id="txt_final_discount_amount_hidden" disabled placeholder="0.000"> 
                                         <input type="hidden" class="form-control form-control-sm" style="color:black;font-weight:700;text-align:right; " id="hidden_gross" disabled placeholder="0.000"> 
                                           
                                        </div>
                                       
                                </div> 
                                <!--<div class="col-sm-12 col-md-2 col-lg-2 custom-font" id="discount_button">-->
                                <!--        <button class="btn btn-primary" id="view_discount">Add Discount</button>-->
			...
			<div class="container mt-1 main-container" id="div_invoice_details">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-12">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                           ...
                           <table id="tbl_invoice_details_list" class="display stripe cell-border" style="width:60%;" style="padding-top:5px;font-size:12px">
                                <thead>
                                    ...
                                    <tr>
                                        <th style="border: 1px solid #dddddd; width:45%">Discount Amount</th>
                                        <th id="table_discount" style="border: 1px solid #dddddd; text-align: right;"></th>
                                    </tr>
				...
				<!--*****************************************-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-12 custom-font">
                                 ...
                                 <textarea class="form-control custom-font"  rows="3" id="txt_invoice_all_description"><figure class="table"><table><tbody><tr><td>For Sapphire Industries W.L.L &nbsp; &nbsp;</td><td>&nbsp;</td><td>Received By</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>Signature_____________________</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>Signature ______________________&nbsp;</td><td>&nbsp;</td><td>Name :&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td colspan="3">&nbsp;</td></tr><tr><td colspan="3">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; All the materials checked and confirmed<br><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Thank you for your business !</strong></td></tr></tbody></table></figure></textarea>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2">
                                    ...
                                    <input type="checkbox" id="bank_details">
                                </div>
                                
								<!--<div class="col-sm-12 col-md-2 col-lg-2">
                                    <button class="btn btn-info" id="btn_view_document">View Document</button>
								...
								<div class="col-sm-12 col-md-6 col-lg-5" style="text-align:right">
                                    <button class="btn btn-primary" id="btn_generate_invoice"> <i class="material-icons">list</i>Generate Tax Invoice</button>
				...
				<div class="modal-body">
				   <div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<label>Description </label>
							<textarea class="form-control" placeholder="" id="txt_reissue_desc" rows="4" >
