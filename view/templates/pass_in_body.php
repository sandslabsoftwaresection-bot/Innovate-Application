           ...
           <!--                                     </div>-->
                                        ...
                                        <!--</div>-->
                                          <div class="form-group custom-font">
            								...
            								<!--		</div>-->
            								<!--		<div class="col-sm-12 col-md-6 col-lg-8">-->
            								<!--			<div id="div_select_issue_note_no">-->
                				<!--							<select class="form-control form-control-sm">-->
                				<!--								<option>--Select Issue Notes--</option>-->
                				<!--							</select>-->
            								<!--			</div>-->
            								<!--			<div class="text-right" style="padding-top:5px;">-->
            								<!--			<button class="btn btn-primary btn-sm" id="list_issue_no" style="font-size: 12px;"> <i class="material-icons">list</i>List</button>-->
            								<!--		</div>-->
            								<!--		</div>-->
        ...
        <!--                        </div>-->
                                 <div class="col-sm-12 col-md-6 col-lg-5" style="text-align:right">
                                    <button class="btn btn-primary" id="btn_generate_pass_in"> <i class="material-icons">list</i>  Generate Pass In</button>
                                     <button style="display:none;" class="btn btn-warning" id="btn_edit_pass_in" style="color:white;"> <i class="material-icons">edit</i>  Update pass_in</button>
                                </div>
                            </div>
