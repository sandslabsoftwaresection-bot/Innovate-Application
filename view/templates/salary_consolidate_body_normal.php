                    ...
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                            <!--<div class="row">-->
                                ...
                                <!--    <label>Pivote</label><br>-->
                                <!--    <input type="checkbox" id="pivote" name="type" value="pivote">-->
                                <!--</div>-->
                                <!--<div class="col-1 col-md-1 col-lg-1">-->
								...
								<!--<div class="col-5 col-md-5 col-lg-5">-->
                                    <label style="font-size: 14px;">Select Date</label><br>
                                    <input type="month" id="month-year" style="width: 150px;height: 30px;font-size: 14px;">
                                <!--</div>-->
                            <!--</div>       -->
                            <!-- <div class="" id="load_table_div">-->
                                    ...
                                    <table class="table " id="salary_normal_table_load" class="display stripe cell-border" style="padding-top:5px;font-size:12px">
                                        <thead>
                                            <tr class="custom-font">
                                                ...
                                                <th style="text-align: center;">Salary Date</th>
        										<th style="text-align: center;">Description</th>
                                                <th style="text-align: center;">Earning Amount</th>
