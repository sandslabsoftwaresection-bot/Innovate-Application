        ...
        <div class="container mt-2 main-container" >
            ...
            <div class="card">
                <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
                    <div class="media w-100 ">
                        ...
                        <div class="media-body">
                            <h5 class="time-title mb-0  text-white">New Amount Type</h5>
                            <p class="mb-0  text-white">Click right icon to get List of Amount Type<span class="status bg-success"> </span></p>
                        </div>
                        ...
                        <!--        <a href="" class="dropdown-item">New</a>-->
                                <button  class="btn btn-sm btn-outline-light" onclick="openNavR()" id="btn_view_list_of_units">List Of Amount Type</button>
                    ...
                    <div class="card-body">
                          ...
                          <div class="row" style="padding-left:10px;padding-right:10px;padding-bottom:10px">
                                <div class="col-lg-12 col-md-4">
                                    <label>Amount Type Name</label>
                                    
                                    <input type="hidden" id="txt_amt_type_id" class="form-control" placeholder="">
                                    <input type="text" id="txt_amt_type" class="form-control" placeholder="">
                                </div>
                ...
                <div class="card-footer">
                    <button class="btn btn-secondary" id="btn_amt_type_cancel">Cancel</button>
                    <button class="btn btn-success float-right" id="btn_amt_type_add">Save</button>
                     <button class="btn btn-warning text-white float-right" id="btn_amt_type_edit">Save</button>
                </div>
...
<div id="mySidenavR" class="sidenavR " height="100%" style="background-color:white;padding-top:70px;">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        <div class="card-header">
                                ...
                                <div class="row ">
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <h5 class="mb-0">List of Amount Type</h5>
                                    </div>
                        ...
                        <!--Table-->
                            <table class="table " id="list_of_amt_type" class="custom-font" style="padding-top:5px;font-size:12px;">
                                <thead>
