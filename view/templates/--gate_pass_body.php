                            ...
                            <div class="card-body "> 
								...
								<div class="form-group custom-font">
									<div class="row" >
										...
										<div class="col-sm-12 col-md-6 col-lg-8">
											<input type="text" class="form-control form-control-sm" value=" " style="color:black;font-weight:700"  id="vehicle_no"> 
										</div>
									</div>
								</div>		
								<div class="form-group custom-font">
									<div class="row" >
										...
										<div class="col-sm-12 col-md-6 col-lg-8">
											<input type="text" class="form-control form-control-sm" value=" " style="color:black;font-weight:700"  id="driver"> 
										</div>
									</div>
								</div>	
								<div class="form-group custom-font">
                    ...
                    <div class="card-body">
                        <div class="row">
							...
							<div class="col-md-4 mb-4 sm-12" style="">
								...
								<textarea class="form-control" id="description" placeholder="Description" required="" rows="1"> </textarea>
							...
							<div class="col-md-1 mb-1 sm-12" style="">
								...
								<input type="text" class="form-control" id="qty" placeholder="Qty" required="">
							</div>
							...
							<div class="col-md-1 mb-1 sm-12" style="padding-top:30px">
								<button type="button" class="mb-2 btn btn-primary" id="btn_gate_pass_add">ADD</button>
								<button type="button" class="mb-2 btn btn-warning" style="color:white" id="btn_gate_pass_edit">SAVE</button>
							</div>
