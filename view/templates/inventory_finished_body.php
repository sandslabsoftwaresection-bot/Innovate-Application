            ...
            <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
				<div class="media w-100 ">
					...
					<div class="media-body">
						<h5 class="time-title mb-0 text-white">Finished Report</h5>
					</div>
				</div>
            </div>
                            ...
                            <div class="card-body w-100">
								<div class="row" >
									...
									<div class="col-lg-6 col-md-4 col-sm-6">
                                        <div id="div_load_inventory_finished">									
											
                                        </div>										
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4">
                                       	<button class="btn btn-dark" id="btn_print_pur_finished"><i class="material-icons">print</i> Print All</button>								
									</div>
								</div>		 
                            </div>      
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-12">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                            <table id="tbl_inventory_finished" class="display stripe cell-border" style="width:100%" style="padding-top:5px;font-size:12px">
                                <thead>
                                    <tr>
                                        <th>SI</th>
			...
			<div class="card rounded-0 border-0 mb-12">
				...
				<div class="card-body ">
				   <div class="row mb-3">
					  ...
					  <div class="col-lg-4 col-md-4 col-sm-4">
						 	<button class="btn btn-dark" id="btn_view_inventory_finished_print"><i class="material-icons">print</i> Print</button>
					  </div>
				   </div>
					<!--Table-->
					<table class="table " id="tbl_view_inventory_details_finished" class="table dataTable" cellspacing="0" style="width: 100%; font-size: 15px;">
