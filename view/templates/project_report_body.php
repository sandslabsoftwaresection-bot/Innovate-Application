                ...
                <div class="col-sm-12 col-md-6 col-lg-12">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                            ...
                            <table id="tbl_project_report_list" class="table table-striped table-bordered" style="width:100%" style="padding-top:5px;font-size:12px">
                                <thead>
                                    <tr>
                        ...
                        <div class="card-footer">
                            <div class="row ">
                                <div class="col-sm-12 col-md-2 col-lg-3">
                                    <button class="btn btn-secondary" id="btn_project_report_print_without_head"><i class="material-icons">print</i>Print Without Head</button>
                                </div>
                               	<div class="col-sm-12 col-md-2 col-lg-2">
                                    <button class="btn btn-dark" id="btn_project_report_print_with_head"><i class="material-icons">print</i>Print With Head</button>
                                </div>
								<!--<div class="col-sm-12 col-md-2 col-lg-2">-->
