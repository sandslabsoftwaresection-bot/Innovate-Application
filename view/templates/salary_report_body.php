                    ...
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                            <div class="row">
								...
								<div class="col-sm-2 col-md-2 col-lg-1" style="padding-top:29px">
									<button class="btn btn-info" id="btn_item_search_date"> <i class="material-icons">search</i> </button>
								</div>   
                            </div>
                              
                            
                            <table id="tbl_supplier_report_list" class="table table-striped table-bordered" style="width:100%" style="padding-top:5px;font-size:12px">
                                <thead>
                                    <tr>
                                       <th>SI</th>
                                        <th>Date</th>
