            ...
            <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
				<div class="media w-100 ">
					...
					<div class="media-body">
						<h5 class="time-title mb-0  text-white">New Gate Pass</h5>
					</div>   
					<div class="dropdown " style="padding-left:50px;">
						...
						<div class="dropdown-menu " aria-labelledby="dropdownMenuButton" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -101px, 0px); top: 0px; left: 0px; will-change: transform;">
							<a class="dropdown-item ladda-button" href="#" onclick="openNavR()" id="view_gate_list" data-style="expand-right"><span class="ladda-label">List of Gate Pass</span><span class="ladda-spinner"></span></a>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-5" id='div_first'>
                        <div class="card rounded-0 border-0 mb-5">       
                            <div class="card-body ">
								...
								<!--		</div>-->
								<!--		<div class="col-sm-12 col-md-6 col-lg-8">-->
												<input type="hidden" class="form-control form-control-sm" id="address" readonly> 
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>-->
								<!--<div class="form-group custom-font">-->
								...
								<!--		</div>-->
								<!--		<div class="col-sm-12 col-md-6 col-lg-8">-->
												<input type="hidden" class="form-control form-control-sm" id="po_box" readonly> 
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>-->
								<!--<div class="form-group custom-font">-->
								...
								<!--		</div>-->
								<!--		<div class="col-sm-12 col-md-6 col-lg-8">-->
												<input type="hidden" class="form-control form-control-sm" id="contact_no" readonly> 
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>-->
								<!--<div class="form-group custom-font">-->
								...
								<!--		<div class="col-sm-12 col-md-6 col-lg-4">-->
										...
										<!--</div>-->
										<!--<div class="col-sm-12 col-md-6 col-lg-8">-->
												<input type="hidden" class="form-control form-control-sm" id="fax" readonly> 
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>     -->
								<!--<div class="form-group custom-font">-->
								...
								<!--		</div>-->
								<!--		<div class="col-sm-12 col-md-6 col-lg-8">-->
												<input type="hidden" class="form-control form-control-sm" id="attn" readonly> 
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>         -->
								<div class="form-group custom-font">
								...
								<div class="form-group custom-font">
									<div class="row" >
										...
										<div class="col-sm-12 col-md-6 col-lg-8">
												<input type="date" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" id="gate_pass_date"> 
										</div>
									</div>
								</div>	
								<div class="form-group custom-font">
									<div class="row" >
										...
										<div class="col-sm-12 col-md-6 col-lg-8">
											<textarea class="form-control form-control-sm" id="txt_note" placeholder="Note" rows="1"> </textarea>
										</div>
									</div>
								</div> 
                            ...
                            <div class="card-body "> 
								<div class="form-group custom-font">
									<div class="row" >
										...
										<div class="col-sm-12 col-md-6 col-lg-8">
											<input type="text" class="form-control form-control-sm"  style="color:black;font-weight:700" disabled id="txt_pass_no"> 
										   <input type="hidden" class="form-control form-control-sm" disabled id="txt_master_ref_id">
										</div>
									</div>
								</div>		
								<!--<div class="form-group custom-font">-->
									<!--<div class="row" >-->
										...
										<!--</div>-->
										<!--<div class="col-sm-12 col-md-6 col-lg-8">-->
											<input type="hidden" class="form-control form-control-sm" value=" " style="color:black;font-weight:700"  id="vehicle_no"> 
										<!--</div>-->
									<!--</div>-->
								<!--</div>		-->
								<!--<div class="form-group custom-font">-->
									<!--<div class="row" >-->
										...
										<!--</div>-->
										<!--<div class="col-sm-12 col-md-6 col-lg-8">-->
											<input type="hidden" class="form-control form-control-sm" value=" " style="color:black;font-weight:700"  id="driver"> 
								<!--		</div>-->
								<!--	</div>-->
								<!--</div>	-->
								<div class="form-group custom-font">
                                ...
                                <div class="form-group custom-font">
									<div class="row">
										...
										<div class="col-sm-12 col-md-6 col-lg-8">
											<div id="div_select_job_no">
											<select class="form-control form-control-sm">
												<option>--Select job No--</option>
											</select>
											</div>
											<a href="" target="_blank" id="list_workorder">View Details</a>
										</div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-12">
                <div class="card rounded-0 border-0 mb-12">    
                    <div class="card-body " style="padding-top:5px;font-size:12px;overflow:auto;">
						<table id="tbl_inventory_list" class="display stripe cell-border" style="width:100%" style="padding-top:5px;font-size:12px">
							<thead>
								<tr>
									<th>SI</th>
									<th>Inventory Item</th>
									<!--<th>Stock Qty(Unit)</th>-->
									<th style="display:none;">Stock Qtyyyyyyy</th>
									<th>Remarks</th>
									<th>Qty</th>
									<th>Action</th>
								</tr>
                       ...
                       <!-- 
                        ...
                        <div class="card-footer">
                            <div class="row">
								...
								<!--<div class="col-sm-12 col-md-2 col-lg-2">-->
        <!--                            <button class="btn btn-info" id="btn_gate_pass_export_excel"><i class="material-icons">exit_to_app</i> Export to Excel</button>-->
        <!--                        </div>-->
                                 <div class="col-sm-12 col-md-6 col-lg-5" style="text-align:right">
                                    <button class="btn btn-primary" id="btn_generate_gate_pass"> <i class="material-icons">list</i>  Generate Gate Pass</button>
            ...
            <div class="card rounded-0 border-0 mb-12">
                <div class="card-header">
					<div class="row">
						<div class="col-sm-10 col-md-10 col-lg-10">
							<h5 class="mb-0">List of Gate Pass</h5>
						</div>
                ...
                <div class="card-body " style="overflow:auto;">
                    <div class="row ">
                        ...
                        <!--Table-->
						    <table class="table " id="list_of_gate_pass" class="custom-font" style="padding-top:5px;font-size:12px;width:100%">
                                <thead>
