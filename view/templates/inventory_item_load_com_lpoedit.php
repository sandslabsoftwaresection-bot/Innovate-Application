...
?>
    ...
    <?PHP 
        $result = mysqli_query($varDBConnection,"SELECT item_id, item_name, item_code,cat_id,cat_name,unit,tax_value FROM store_items WHERE cat_id= '".$_GET['category_id']."' and status = 'Active' ORDER BY item_name ASC");
