                    ...
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                           ...
                           <div class="row">
                                ...
                                <!--        <label>Dis%</label>-->
                                <!--        <input type="text" class="form-control form-control-sm" style="color:black;font-weight:700;text-align:right" placeholder="0.000" id="txt_invoice_vat"> -->
                                <!--         <input type="hidden" class="form-control form-control-sm" style="color:black;font-weight:700;text-align:right" disabled id="txt_invoice_total_amount" placeholder="0.000"> -->
...
<div id="mySidenavR" class="sidenavR " height="100%" style="background-color:white;z-index: 999">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <!--Table-->
                            <table class="table responsive" id="list_of_invoices" class="custom-font" style="padding-top:5px;font-size:12px">
                                <thead>
