        ...
        <div class="container mt-2 main-container" >
            ...
            <div class="card">
                <div class="card-header text-white" style="background: linear-gradient(90deg, rgba(10,87,173,1) 0%, rgba(23,148,255,1) 13%, rgba(0,44,215,0.9780287114845938) 100%);">
                    <div class="media w-100 ">
                        ...
                        <div class="media-body">
                            <h5 class="time-title mb-0  text-white">New Unit</h5>
                            <p class="mb-0  text-white">Click right icon to get List of Unit<span class="status bg-success"> </span></p>
                        </div>
                        ...
                        <!--        <a href="" class="dropdown-item">New</a>-->
                                <button  class="btn btn-sm btn-outline-light" onclick="openNavR()" id="btn_view_list_of_units">List Of Unit</button>
                    ...
                    <div class="card-body">
                          ...
                          <div class="row" style="padding-left:10px;padding-right:10px;padding-bottom:10px">
                                <div class="col-lg-12 col-md-4">
                                    ...
                                    <input type="hidden" id="txt_unit_id" class="form-control" placeholder="">
                                    <input type="text" id="txt_unit" class="form-control" placeholder="">
                                </div>
                ...
                <div class="card-footer">
                    <button class="btn btn-secondary" id="btn_unit_cancel">Cancel</button>
                    <button class="btn btn-success float-right" id="btn_unit_add">Save</button>
                     <button class="btn btn-warning text-white float-right" id="btn_unit_edit">Save</button>
                </div>
...
<div id="mySidenavR" class="sidenavR " height="100%" style="background-color:white;padding-top:70px;">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0px">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <!--Table-->
                            <table class="table " id="list_of_unit" class="custom-font" style="padding-top:5px;font-size:12px;">
                                <thead>
