    ...
    <div class="container mt-12 main-container">
                ...
                <div class="col-sm-12 col-md-6 col-lg-12">
                    <div class="card rounded-0 border-0 mb-12">
                        ...
                        <div class="card-body " style="padding-top:5px;font-size:12px">
                            <div class="col-sm-3 col-md-3 col-lg-3" style="padding-bottom:50px;">
									<label>Select Option</label>
									<div id="div_option_select">
						...
						<!--<div id="show_details"> 		-->
                            <div class="row">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									...
									<div id="div_select_supplier">
										<select class="form-control form-control-sm">
											<option>--Select Supplier--</option>
										</select>
									</div>
								</div>
								<div class="col-3 col-md-3 col-lg-3" id="date_div">
                                ...
                                <table id="tbl_purchase_recived_report_list" class="table table-striped table-bordered" style="width:100%" style="padding-top:5px;font-size:12px">
                                <thead>
                                    <tr>
                                       <th>SI</th>
                                        <th>Company Name</th>
       ...
       <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="purchase_recieved_history">
    <div class="modal-dialog modal-xl" role="document" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Purchase Recieved History</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <table id="prd_history" class="table table-striped table-bordered" style="width:100%; padding-top:5px; font-size:12px;">
                            <thead>
                                <tr>
                                    <th>SI</th>
                                    <th>PRD Number</th>
