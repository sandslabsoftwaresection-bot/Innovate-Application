    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/new_delivery_note_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/new_delivery_note_body.php')?>
        <!-- content page ends -->
...
<script src="vendor/chosen1.8/chosen.jquery.min.js"></script>
    ...
    <script src="../httpdocs/user_js/delivery_note_new.js"></script>
