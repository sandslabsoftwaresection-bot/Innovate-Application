...
$pdf->AddPage();
	  ...
	  $content .='<tr style="border-bottom: 1px solid gray;">';
                        			  ...
                        			  $tot_amt=number_format($amt_tbl,3);
                                      $content = $content.$tot_amt;
                                      $content = $content.'</strong></td>';
                                      $content .='</tr>';
                                      
                                      $content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td colspan="5" style="text-align: left;'.$border_bottom_line.' "><strong>Total VAT in BHD</strong></td>';
                        			  $content .='<td style="text-align: right;'.$border_left.';'.$border_bottom_line.';"><strong>';
                                      $vat_amt=number_format($v_rate,3);
                                      $content = $content.$vat_amt;
                                      $content = $content.'</strong></td>';
                                      $content .='</tr>';
                                      
                                      $content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td colspan="5" style="text-align: left;'.$border_bottom_line.' "><strong>Total Net Amount in BHD</strong></td>';
                        			  $content .='<td style="text-align: right;'.$border_left.';'.$border_bottom_line.';"><strong>';
      ...
      <td >
        ...
        <tbody>
          <tr >
            ...
            <td bgcolor="$table_title_bg" style="width:50%;$table_title_style"> <strong>Description</strong></td>
            ...
            <td bgcolor="$table_title_bg" style="width:14%;$table_title_style"><strong>Amount</strong></td>
