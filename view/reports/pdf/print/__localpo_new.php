                ...
                $discount=0;
                 $result = mysqli_query($conns,"select * from local_po_child_tbl where local_po_no = '".$_GET['local_po_number']."'"); 
                     while($row=mysqli_fetch_assoc($result)) {
                                            ...
                                            $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.number_format(($row["discount_amount"]*$row['vat_percentage']/100),2).'</td>';
                        			   ...
                        			   $content .='<td colspan="7" style="text-align: left;'.$border_bottom_line.' "><strong>Total Amount in BHD</strong></td>';
