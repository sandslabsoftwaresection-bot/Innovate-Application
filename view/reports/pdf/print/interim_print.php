    ...
    while($row=mysqli_fetch_assoc($result)) {
       ...
       if($row['retention_amount_percentage']!=0)
		 ...
		 if($retention_amount_type=='%'){
			 $v_retention=number_format($retention_amount_percentage, 3);
...
$pdf->AddPage();
        ...
        else
            {
             ...
             $val=  $total_discount / $total_quantity  ;
                 ...
                 $result = mysqli_query($conns,"SELECT  `invoice_child_id`, `delivery_note_child_id`, `invoice_no`, `quotation_child_id`, `delivery_note_no`, `quotation_no`, `description`, `quantity`, `unit`, `rate`, `amount`,`discount_type`, `discount_precentage`, `discount_amount`, `vat_percentage`,`net_amount` as net_amount, `default_date`, `quotation_status`, `required_quantity`,`purchase_qty`,`purchase_amount_pr`,supplied_amount_pr from intern_payment_child_tbl where invoice_no = '".$_GET['invoice_number']."'");
                     ...
                     while($row=mysqli_fetch_assoc($result)) {
						...
						$unit_rate=$row['rate'];
						 ...
						 $netamount_chiled=$row['net_amount'];
                        $amount_inchild=$row['amount'];
                        $purchase_amount_pr_inchild=$row['purchase_amount_pr'];
                        $supplied_amount_pr_inchild=$row['supplied_amount_pr'];
                        $executed_work=$purchase_amount_pr_inchild+$supplied_amount_pr_inchild;
                        $last_period=($amount_inchild*$supplied_amount_pr_inchild)/100;
                        $cum_upto_this=$last_period+$netamount_chiled;
                        $netAmounts[] = $row['net_amount'];
                        $cum_sum[]=$cum_upto_this;
                        $amount_arr[]=$row['amount'];
                        $last_period_arr[]=$last_period;
				    	...
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($amount_inchild,3).'</td>';
				    	$content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($executed_work,2).'%</td>';
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($cum_upto_this,3).'</td>';	 
				    	$content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($supplied_amount_pr_inchild,2).'%</td>';
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($last_period,3).'</td>';	 
				    	$content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($purchase_amount_pr_inchild,2).'%</td>';	 
				...
				$netAmountSum = array_sum($netAmounts);
				$cum_AmountSum = array_sum($cum_sum);
				$Amount_array_Sum = array_sum($amount_arr);
				$last_period_Sum = array_sum($last_period_arr);
				
				$content .= '<tr>';
                $content .= '<td colspan="4" style="text-align: left;'.$border_bottom_line.';"><b>Total Amount</b></td>';
                $content .= '<td colspan="2" style="text-align: right;'.$border_bottom_line.';"><b>'.number_format($Amount_array_Sum, 3).'</b></td>';
                // $content .= '<td  style="text-align: right;'.$border_top.';"></td>';
                $content .= '<td colspan="2" style="text-align: right;'.$border_bottom_line.';"><b>'.number_format($cum_AmountSum, 3).'</b></td>';
                // $content .= '<td  style="text-align: right;'.$border_top.';"></td>';
               $content .= '<td colspan="2" style="text-align: right;'.$border_bottom_line.';"><b>'.number_format($last_period_Sum, 3).'</b></td>';
                // $content .= '<td  style="text-align: right;'.$border_top.';"></td>';
                $content .= '<td colspan="2" style="text-align: right;'.$border_bottom_line.';"><b>'.number_format($netAmountSum, 3).'</b></td>';
                $content .= '</tr>';
            ...
            //             			  $content .='</tr>';
                        ...
                        // 			}
                        			...
                        			$content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td colspan="10" style="text-align: left;'.$border_bottom_line.' "><strong>Gross Value of work BD </strong></td>';
                        			...
                        			$content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td colspan="10" style="text-align: left;'.$border_bottom_line.' "><strong>Up to Last Period BD</strong></td>';
                        			...
                        			if($previous_bill_amount!=0){
                        			$content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td colspan="10" style="text-align: left;'.$border_bottom_line.' "><strong>Net Amount Due BD</strong></td>';
                        			...
                        			if($retention_amount!=0){
                                            ...
                                            //   $content .='<td style="text-align: right;'.$border_left.';'.$border_bottom_line.'"></td>';
											  if($v_retention!=0){
												$content .='<td style="text-align: left;'.$border_bottom_line.' " colspan="10"><strong>Less :- Retention '.$v_retention.'% </strong></td>';
											    ...
											    $content .='<td style="text-align: left;'.$border_bottom_line.' " colspan="10"><strong>Less :- Retention BD</strong></td>';
                        			...
                        			$grant_total_amt=$sub_rete-$v_rec_amt;
                        			   ...
                        			   if($v_rec_amt!=0){
                                            $content .='<tr style="border-bottom: 1px solid gray;">';
											  ...
											  if($v_recied_pr!=0){
											  $content .='<td colspan="10" style="text-align: left;'.$border_bottom_line.'"><strong>Less :- Advance received '.$v_recied_pr.'%</strong></td>';   
                                             // $content .='<td style="text-align: left;'.$border_left.';'.$border_bottom_line.'; "><strong>'.$v_recied_pr.'%</strong></td>';
                                              $content .='<td colspan="2" style="text-align: right;'.$border_left.';'.$border_bottom_line.'; "><strong>'.number_format($v_rec_amt,3).'</strong></td>';
											    ...
											    $content .='<td colspan="10" style="text-align: left;'.$border_bottom_line.'"><strong>Less :- Advance received BD</strong></td>';   
                        			  ...
                        			  $content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td colspan="10" style="text-align: left;'.$border_bottom_line.' "><strong>Grand Total (Ex-VAT)</strong></td>';
                        			  ...
                        			  $content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td style="text-align: left;'.$border_bottom_line.' " colspan="10"><strong>Tax (VAT) '.number_format($tax_content,0).'%</strong></td>';
                        			 ...
                        			 $content .='<tr style="border-bottom: 1px solid gray;">';
                        			  $content .='<td style="text-align: left;'.$border_bottom_line.';" colspan="10"><strong>Total Amount Due in BD</strong></td>';
                    				...
                    				$content = $content.'    <td colspan="12" style="text-align: center; font-size:12px;"><strong>Bahraini Dinars: '.trim($words).'&nbsp;only</strong>';
                        			$content = $content.'</td>';
                        			$content = $content.'    </tr>';
  ...
  <tbody>
          ...
          <tr>
            ...
            <td align="right" valign="top" style="background-color:red;" >
				<table width="100%"  cellspacing="0" cellpadding="5">
					<tbody>
						<tr >
						  <td width="45%" bgcolor="white"></td>
						  <td width="55%"style="text-align: right; color: #FFFFFF; font-size: 24px;  " bgcolor="$table_title_bg">INTERIM PAYMENT</td>
						</tr>
    ...
    <tr>
      <td>
        ...
        <tbody>
            <tr>                    
    				<th width="55%" bgcolor="$table_title_bg" style="$table_title_style" colspan="6"><strong>Approved Quotation QN:</strong></th>
    				<th width="15.5%" bgcolor="$table_title_bg" style="$table_title_style" colspan="2"><strong>Gross Value of Work</strong></th>
    				<th width="14.5%" bgcolor="$table_title_bg" style="$table_title_style" colspan="2"><strong>Up to Last Period</strong></th>
    				<th width="14%" bgcolor="$table_title_bg" style="$table_title_style" colspan="2"><strong>Net Amount Due</strong></th>
					
			</tr>
                                    <tr>
                                        <th  width="2%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>SI</strong></th>
                                        <th  width="27%"  bgcolor="$table_title_bg" style="$table_title_style" ><strong>Description</strong></th>
                                        <th  width="5.8%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Qty</strong></th>
                                        <th  width="4.5%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Unit</strong></th>
										<th  width="6.9%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Rate</strong></th>
                                        <th  width="8.9%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Amount</strong></th>
                                        <th width="6%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Executed Work</strong></th>
                                        <th width="9.5%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Amount</strong></th>
                                        <th width="6%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Executed Work</strong></th>
                                        <th width="8.5%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Amount</strong></th>
                                        <th width="6%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Executed Work</strong></th>
										<th width="8%" bgcolor="$table_title_bg" style="$table_title_style" ><strong>Net Amount</strong></th>
