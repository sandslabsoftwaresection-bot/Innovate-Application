...
$pdf->AddPage();
						...
						$content = $content .'<table width="99%" border="0" cellspacing="0" cellpadding="10">';
						...
						//$content = $content .'<td style="border-bottom: 1pt solid black;">Cash</td>';
						//$content = $content .'<td style="text-align: center; border-bottom: 1pt solid black;"></td>';
						//$content = $content .'<td style="border-bottom: 1pt solid black;">Cheque</td>';
						//$content = $content .'<td style="text-align: center; border-bottom: 1pt solid black;"></td>';
						//$content = $content .'<td style="border-bottom: 1pt solid black;">Transfer</td>';
						//$content = $content .'<td style="text-align: center; border-bottom: 1pt solid black;"></td>';
						$content = $content .'<td style="border-bottom: 1pt solid black;width:223px;">Date : <strong>' . $receipts_date . '</strong></td>';
						$content = $content .'</tr>';
						$content = $content .'</tbody>';
						...
						$content = $content . '<tbody>';
						$content = $content . '<tr>';
						$content = $content . '<td width="25%" align="left" valign="middle">Received with thanks from :</td>';
						$content = $content . '<td width="75%" align="left" valign="middle" style="text-align: left; border-bottom: 1pt solid black;width:75%;"><strong>'.$received_from.'</strong></td>';
						$content = $content . '</tr>';
						$content = $content . '</tbody>';
						...
						$content = $content . '<tr>';
						$content = $content . '<td colspan="2">';
						$content = $content . '<table width="100%" border="0" cellpadding="0" cellspacing="10">';
						$content = $content . '<tbody>';
						$content = $content . '<tr>';
						$content = $content . '<td width="25%" align="left" valign="middle">The Sum of BD.</td>';
						$content = $content . '<td width="75%" align="left" valign="middle" style="text-align: left; border-bottom: 1pt solid black;"><strong>';
						...
						$content = $content . '<tbody>';
						$content = $content . '<tr>';
						$content = $content . '<td width="17%">By Cheque No/ TRF :</td>';
						$content = $content . '<td width="20%" style="border-bottom: 1pt solid black;">' . $cheque_no . '</td>';
						$content = $content . '<td width="14%">Bank :</td>';
						$content = $content . '<td width="20%" style="border-bottom: 1pt solid black;">' . $bank . '</td>';
						$content = $content . '<td width="12%">Date :</td>';
						$content = $content . '<td width="16%" style="border-bottom: 1pt solid black;">' . $cheque_date . '</td>';
						$content = $content . '</tr>';
						$content = $content . '<tr>';
						$content = $content . '<td colspan="6">';
						$content = $content . '<table width="99%" border="0" cellspacing="0" cellpadding="5">';
						$content = $content . '<tbody>';
						$content = $content . '<tr>';
						$content = $content . '<td width="24%" style="padding-left: 0px;">The Sum of BD.</td>';
						$content = $content . '<td width="75%" style="border-bottom: 1pt solid black;"><strong>';
						$splitamount = explode('.', $total_amount);
						if (intval($splitamount[1]) <= 0) {
							$content = $content . getCurrency($splitamount[0]) . ' only';
						} else {
						...
						$content = $content . '</tr>';
						$content = $content . '<tr>';
						$content = $content . '<td>Received :</td>';
						$content = $content . '<td style="border-bottom: 1pt solid black;">' . $received_by . '</td>';
						$content = $content . '<td>Verified :</td>';
						$content = $content . '<td style="border-bottom: 1pt solid black;">' . $verified_by . '</td>';
						$content = $content . '<td>Amount BD :</td>';
						$content = $content . '<td style="border-bottom: 1pt solid black;"><strong>' . number_format($total_amount, 3) . '</strong></td>';
						$content = $content . '</tr>';
						$content = $content . '<tr>';
						$content = $content . '<td>Signature :</td>';
