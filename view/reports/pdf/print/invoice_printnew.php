...
$pdf->AddPage();
        ...
        else
            {
             ...
             $val=  $total_discount / $total_quantity  ;
			  ...
			  $content .='<td colspan="1" style="text-align: right;'.$border_left.';'.$border_bottom_line.';"><strong></strong></td>';
			 ...
			 $content .='<tr style="border-bottom: 1px solid gray;">';
			  ...
			  $content .='</tr>';
				...
				if($_GET['z']==1){
                    ...
                    $bank.='<br>';
                    $bank.='<tr>';
                    $bank.='<td colspan="3" style="text-align:left">'; // $bank.='<br>AHLI UNITED BANK';
                    $bank.='<br>AL SALAM BANK'; // $bank.='<br>A/C NO 	:- 0017314586001';
                    $bank.='<br>A/C NO 	:- 403648100100';  // $bank.='<br>IBAN 	:- BH52AUBB00017314586001';
                    $bank.='<br>IBAN 	:- BH41ALSA00403648100100';
                    $bank.='<br>BRANCH 	:- MANAMA';  //BUDAIYA
