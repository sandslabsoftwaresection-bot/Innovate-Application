...
// Create connection
   ...
   $conns = $db_con->ConnectToMYSQL();
     ...
     $result = mysqli_query($conns,"select * from  service_note_main_tbl  where service_note_number = '".$_GET['service_note_number']."'");
    while($row=mysqli_fetch_assoc($result)) {
        $service_note_number =$row['service_note_number'];
        $service_note_created_date = date("d-M-Y", strtotime($row['service_note_created_date']));
...
$pdf->AddPage();
              ...
              $i=0;
				//  $result = mysqli_query($conns,"select * from  gate_pass_child_tbl where pass_no = '".$_GET['pass_no']."'");
					 $result = mysqli_query($conns,"select * from  service_note_child_tbl where service_note_number = '".$_GET['service_note_number']."'");
                     while($row=mysqli_fetch_assoc($result)) {
                        $inventory_id=$row['inventory_cat_id'];
                        $inventory_name=$row['inventory_cat_name'];
                        $item_id=$row['item_id'];
                        ...
                        $i++; 
                                            ...
                                            $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.$description.'</td>';
                                            ...
                                            $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';"></td>';
                                            $content .='</tr>';
...
// {
//     $td_note.='<tr>';
//     $td_note.='<td style="text-align: left;'. $para_justify.';">'.$description.'</td>';  
//     $td_note.='</tr>';
// }
// else
// {
//     $td_note .= '<tr><td style="text-align: left;border-bottom: 1px solid #21467b;"></td></tr>'; 
//      $td_note .= '<tr><td></td></tr>'; 
//     $td_note .= '<tr><td style="text-align: left;border-bottom: 1px solid #21467b;"></td></tr>'; 
// }
  ...
  <tbody>
    <tr >
      <td style="padding-left:0px;padding-right:10px;">
        ...
        <tbody>
          <tr>
            <td width="49%" align="left" valign="top" style="padding: 0px;"></td>
            <td align="left" valign="top" >
				<table width="100%"  cellspacing="0" cellpadding="5">
					<tbody>
						<tr >
						  <td style="text-align: center; color: #FFFFFF; font-size: 26px; " bgcolor="$table_title_bg">SERVICE NOTE</td>
						</tr>
          ...
          <tr>
            <td  align="left" valign="top" style="padding: 0px;"><table width="100%"  style="padding-top:8px;" >
                    <tr style="text-align: left;">
                        <td >Company Name: <strong> $company_name </strong> </td >
                    </tr>    
                    <tr style="text-align: left;">    
                        <td >Service Name : <strong>$service_name</strong></td >
                    </tr>    
                    <tr style="text-align: left;">    
                       <td >Location : <strong>$address</strong></td >
                    </tr>   
                </table>
            </td>
              <td align="left" >
                  ...
                  <tbody>
                    ...
                    <tr style="text-align: right;">
                      <td >Service No : <strong>$service_note_number</strong></td>
                    </tr>
                    <tr style="text-align: right;">
                      <td>Date : <strong>$service_note_created_date</strong></td>
                    </tr>
                    <tr style="text-align: right;">
                      <td>Tele-Phone : <strong>$telephone_no</strong></td>
                    </tr>
      ...
      <td>
        ...
        <tbody>
          <tr >
              ...
              <td  width="50%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Description</strong></td>
