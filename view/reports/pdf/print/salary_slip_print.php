...
// helvetica or times to reduce file size.
  $color = "#21467b";
                        ...
                        $border_colour= "border: 1px solid #21467b;";
// add a page
$pdf->AddPage();
                     ...
                     while($row=mysqli_fetch_assoc($result)) {
						...
						if($status=="Allowence")
						{
            				...
            				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
            						$content_allo = $content_allo . '<td bgcolor="#ebe9e4" style="text-align: left; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . '</td>';
						    ...
						    else
						    {
						        	$content_allo = $content_allo . '<tr nobr="true">';
            				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
            						$content_allo = $content_allo . '<td bgcolor="#ebe9e4" style="text-align: left; border-top: 1px solid #21467b; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . '</td>';
            						$content_allo = $content_allo . '<td bgcolor="#ebe9e4" style="text-align: right; border-top: 1px solid #21467b; line-height: 20px;">' . number_format($earning_amt,3) . '</td>';
            						$content_allo = $content_allo . '</tr>';
            						$allo_tot=$allo_tot+$earning_amt;
						    }
                				...
                				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
                						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: left; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . ' ('.$gosi_pr.' %)</td>';
                						...
                						$ded_tot=$ded_tot+$deduction_amt;
						                 ...
						                 $content_ded = $content_ded . '<tr nobr="true">';
                				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
                						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: left; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . ' ('.$leave_days.' days)</td>';
                						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: right; line-height: 20px;">' . number_format($deduction_amt,3) . '</td>';
                						$content_ded = $content_ded . '</tr>';
                						$ded_tot=$ded_tot+$deduction_amt;
						            }
    						            ...
    						            $content_ded = $content_ded . '<tr nobr="true">';
                				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
                						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: left; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . '</td>';
                						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: right; line-height: 20px;">' . number_format($deduction_amt,3) . '</td>';
                						$content_ded = $content_ded . '</tr>';
                						$ded_tot=$ded_tot+$deduction_amt;
						            }
						                ...
						                if($allo_ded_tbl_id==1)
						                    {
						                        $content_ded = $content_ded . '<tr nobr="true">';
                        				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
                        						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: left; border-top: 1px solid #21467b; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . ' ('.$gosi_pr.' %)</td>';
                        						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: right; border-top: 1px solid #21467b; line-height: 20px;">' . number_format($deduction_amt,3) . '</td>';
                        						$content_ded = $content_ded . '</tr>';
                        						$ded_tot=$ded_tot+$deduction_amt; 
						                    }
						                    else if($allo_ded_tbl_id==2)
						                    {
						                        $content_ded = $content_ded . '<tr nobr="true">';
                        				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
                        						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: left; border-top: 1px solid #21467b; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . ' ('.$leave_days.' days)</td>';
                        						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: right; border-top: 1px solid #21467b; line-height: 20px;">' . number_format($deduction_amt,3) . '</td>';
                        						$content_ded = $content_ded . '</tr>';
                        						$ded_tot=$ded_tot+$deduction_amt; 
						                    }
						                         ...
						                         $content_ded = $content_ded . '<tr nobr="true">';
                        				// 		$content = $content . '<td bgcolor="#f2f2f2" style="text-align: center; border-right: 1px solid black; border-left: 1px solid #000;">' . $i . '</td>';
                        						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: left; border-top: 1px solid #21467b; line-height: 20px; border-right: 1px solid #21467b;">' . $allow_deduction . '</td>';
                        						$content_ded = $content_ded . '<td bgcolor="#ebe9e4" style="text-align: right; border-top: 1px solid #21467b; line-height: 20px;">' . number_format($deduction_amt,3) . '</td>';
                        						$content_ded = $content_ded . '</tr>';
                        						$ded_tot=$ded_tot+$deduction_amt;
						                    }
...
<table width="100%" cellspacing="0" cellpadding="5">
    <tbody>
        <tr>
            ...
            <td style="text-align: center; color: #FFFFFF; font-size: 24px; font-family: 'Century Gothic';width:50%;" bgcolor="#21467b">
                SALARY SLIP
            </td>
        </tr>
    </tbody>
...
<table width="100%" border="1" cellpadding="3" style="border-collapse: collapse;">
  <tbody>
    <tr style="$style_padding">
      <td  colspan="4" align="center" bgcolor="#21467b" style="color: white;"><b>Pay Slip for the month of  $slip_in_date</b></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr bgcolor="#21467b" style="color: white;">
    ...
    <tr style="padding: 0px;">
      <td colspan="4" style="padding: 0px;">
			...
			<table width="100%" cellpadding="3" border="1" style="border-collapse: collapse; text-align: right;">
		  		...
		  		<tr>
				  <td colspan="4" align="center" bgcolor="#21467b" style="color: white;"><b>Overtime Summary</b></td>
				</tr>
				<tr>
