...
// helvetica or times to reduce file size.
                        ...
                        $color = "#21467b";
                        $border_bottom = "border-bottom: 1px solid #21467b;border-top: 1px solid #21467b;border-right: 1px solid #21467b;";
                        $border_bottom_line= "border-bottom: 1px solid #21467b;border-top: 1px solid #21467b;";
                        $border_left = "border-left: 1px solid #21467b";
                        $table_border = 'border: 1px solid #21467b;';
...
<table width="100%" border="0" cellspacing="0"   id="main_table" style="$table_background.$table_border">
  ...
  <tbody>
	...
	<tr>
      <td><table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" style="$table_border">
        <tbody>
          <tr >
            <td width="57%" align="left" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';" ><strong>Total Income</strong></td>
            <td width="20%" align="right" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;<strong>$income_total</strong></td>
            <td width="23%" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;</td>
          </tr>
          <tr>
            <td align="left" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';"><strong>Balance Amount</strong></td>
            <td align="right" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;<strong>$balance_amount</strong></td>
  ...
  <tbody>
    <tr>
      <td width="57%" align="left" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';"><strong>Total Expense</strong></td>
      <td width="20%" align="right" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;<strong>$exp_total</strong></td>
      <td width="23%" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;</td>
    </tr>
    <tr>
      <td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;</td>
...
$pdf->Output('FUND FLOW STATEMENT '.$date_between.'.pdf', 'I');
