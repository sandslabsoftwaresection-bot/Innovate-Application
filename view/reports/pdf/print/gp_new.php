...
$pdf->AddPage();
              ...
              $i=0;
				//  $result = mysqli_query($conns,"select * from  gate_pass_child_tbl where pass_no = '".$_GET['pass_no']."'");
					 $result = mysqli_query($conns,"select * from  purchase_recieved_child_tbl where ref_no = '".$_GET['pass_no']."' and entry_type = 'IssueNote'");
                     while($row=mysqli_fetch_assoc($result)) {
                        ...
                        $i++; 
                                            ...
                                            $content .=  '<td style="text-align: left;'.$para_justify.$border_bottom.$border_left.';">'.$inventory_name.'</td>';
      ...
      <td>
        ...
        <tbody>
          <tr >
              ...
              <td width="54%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Description</strong></td>
              <td  width="20%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Qty</strong></td>
              <td width="20%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Unit</strong></td>
    ...
    <td>
     	...
     	<table width="100%" border="0" cellspacing="0" cellpadding="2" align="left" valign="middile">
				  <tbody>
					...
					<td align="right"><strong>Received by</strong></td>
					</tr>
