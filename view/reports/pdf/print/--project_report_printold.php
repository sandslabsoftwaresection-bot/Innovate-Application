...
$pdf->AddPage();
                ...
                $result_project_repport = mysqli_query($conns,"SELECT ids, inventory_id, inventory_name, store_category_id, store_category, item_code, unit, description, quantity, damage_qty, qty_out, recieved_date, ref_no, master_ref_id, entry_type,company_name,project_name from purchase_recieved_child_tbl where project_id='".$_GET['project_id']."'");               
                while($row=mysqli_fetch_assoc($result_project_repport)) {
                    ...
                    $unit=$row['unit'];
                                ...
                                $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.$entry_type.'</td>';
                                $content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$store_category.'</td>';
                                $content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$inventory_name.'</td>';
                                $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.$qty_out.'</td>';
                                $content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$quantity.'</td>';
                                $content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$damage_qty.'</td>';
                                $content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$unit.'</td>';
                                $content .='</tr>';	
				...
				<table width="100%"  cellspacing="0" cellpadding="5">
					<tbody>
						<tr >
						  ...
						  <td style="text-align: center; color: #FFFFFF; font-size: 24px;  " bgcolor="$table_title_bg">PROJECT REPORT</td>
						</tr>
      ...
      <td>
        ...
        <tbody>
          <tr >
            ...
            <td width="14%" bgcolor="$table_title_bg" style="$table_title_style"> <strong>Ref No</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Date</strong></td>
          <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Status</strong></td>
          <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Category</strong></td>
            <td width="14%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Description</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Delivery Qty</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Return Qty</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Damage Qty</strong></td>
