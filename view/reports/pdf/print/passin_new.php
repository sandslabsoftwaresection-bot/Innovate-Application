...
$pdf->AddPage();
              ...
              $i=0;
                 $result = mysqli_query($conns,"select * from  purchase_recieved_child_tbl where ref_no = '".$_GET['pass_in_no']."' and entry_type = 'PassIN'");
                     while($row=mysqli_fetch_assoc($result)) {
                        ...
                        $i++; 
                                            ...
                                            $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.$inventory_name.'</td>';
      ...
      <td>
        ...
        <tbody>
          <tr >
              ...
              <td width="40%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Description</strong></td>
              <td  width="24%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Inventory</strong></td>
    ...
    <td>
     	...
     	<table width="100%" border="0" cellspacing="0" cellpadding="2" align="left" valign="middile">
				  <tbody>
				    ...
				    <td align="right"><strong>Recieved By</strong></td>
				    ...
				    <td align="center"><strong>$checked_by</strong></td>
				    <td align="right"><strong>$received_by</strong></td>
