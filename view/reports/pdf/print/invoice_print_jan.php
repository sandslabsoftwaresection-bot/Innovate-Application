...
$pdf->AddPage();
        ...
        else
            {
             ...
             $val=  $total_discount / $total_quantity  ;
                 ...
                 $result = mysqli_query($conns,"SELECT  `invoice_child_id`, `delivery_note_child_id`, `invoice_no`, `quotation_child_id`, `delivery_note_no`, `quotation_no`, `description`, `quantity`, `unit`, `rate`, `amount`,`discount_type`, `discount_precentage`, `discount_amount`, `vat_percentage`,`net_amount` as net_amount, `default_date`, `quotation_status`, `required_quantity`,`purchase_qty`,`purchase_amount_pr`,supplied_amount_pr from invoice_child_tbl where invoice_no = '".$_GET['invoice_number']."'");
                     ...
                     while($row=mysqli_fetch_assoc($result)) {
                        ...
                        $last_period_arr[]=$last_period;
                          ...
                          $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($row['quantity']).'</td>';
				    	...
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($executed_work).'%</td>';
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($cum_upto_this,3).'</td>';	 
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($supplied_amount_pr_inchild).'%</td>';
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($last_period,3).'</td>';	 
				    	$content .=  '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.number_format($purchase_amount_pr_inchild).'%</td>';	 
				...
				$content .= '<tr>';
                $content .= '<td colspan="5" style="text-align: right;'.$border_top.';"></td>';
                $content .= '<td  style="text-align: right;'.$border_top.';">'.number_format($Amount_array_Sum, 3).'</td>';
                $content .= '<td  style="text-align: right;'.$border_top.';"></td>';
                $content .= '<td  style="text-align: right;'.$border_top.';">'.number_format($cum_AmountSum, 3).'</td>';
                $content .= '<td  style="text-align: right;'.$border_top.';"></td>';
               $content .= '<td  style="text-align: right;'.$border_top.';">'.number_format($last_period_Sum, 3).'</td>';
                $content .= '<td  style="text-align: right;'.$border_top.';"></td>';
                $content .= '<td style="text-align: right;'.$border_top.';">'.number_format($netAmountSum, 3).'</td>';
                $content .= '</tr>';
                
                
			  $content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Total Amount (Ex-VAT)</strong></td>';
			  $content .='<td style="text-align: right;'.$border_left.';'.$border_bottom_line.';"><strong>'.number_format($qt_sub_total,3).'</strong></td>';
			  $content .='</tr>';
...
// 			}
			...
			$content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Gross Value of work BD </strong></td>';
			...
			$content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Up to Last Period BD</strong></td>';
			 
			  $content .='<td style="text-align: right;'.$border_left.';'.$border_bottom_line.'" colspan="1"><strong>'.number_format($previous_bill_amount,3).'</strong></td>';
			$content .='</tr>';
			}
			
			$nt_amt_due=$v_net_amt;
			
			$content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Net Amount Due BD</strong></td>';
			...
			$content .='</tr>';
                ...
                $content .='<tr style="border-bottom: 1px solid gray;">';
				 ...
				 if($v_retention!=0){
				     $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Less :- Retention'.$v_retention.'% </strong></td>';
					...
					$content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Less :- Retention BD</strong></td>';
					$content .='<td  style="text-align: right;'.$border_left.';'.$border_bottom_line.';"><strong>'.number_format($retention_amount,3).'</strong></td>';
				 }
...
// 			}
             ...
             if($v_rec_amt!=0){
                $content .='<tr style="border-bottom: 1px solid gray;">';
                  if($v_recied_pr!=0){
				  $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Less :- Advance received '.$v_recied_pr.'%</strong></td>';   
                  $content .='<td style="text-align: right;'.$border_left.';'.$border_bottom_line.';"><strong>'.number_format($v_rec_amt,3).'</strong></td>';
				 }
				 else{
				     $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Less :- Advance received BD</strong></td>';   
			  ...
			  $content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td colspan="11" style="text-align: left;'.$border_bottom_line.' "><strong>Grand Total (Ex-VAT)</strong></td>';
			  ...
			  $content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td style="text-align: left;'.$border_bottom_line.' " colspan="11"><strong>Tax (VAT) '.number_format($tax_content,0).'%</strong></td>';
			 ...
			 $content .='<tr style="border-bottom: 1px solid gray;">';
			  $content .='<td style="text-align: left;'.$border_bottom_line.';" colspan="11"><strong>Total Amount in Due BD</strong></td>';
			  ...
			  $content .='</tr>';
				...
				$content = $content.'    <td colspan="12" style="text-align: center; font-size:12px;"><strong>Bahraini Dinars:'.$words.'&nbsp;only</strong>';
    			$content = $content.'</td>';
    			$content = $content.'    </tr>';
				if($intern_app_ref!=""){
  ...
  <tbody>
    ...
    <tr>
      <td>
         ...
         <table width="99%"  cellspacing="0" cellpadding="3"  style="border-collapse: collapse;border: .7em solid $color;$table_background" >
        <tbody>
            <tr>                    
    				...
    				<th width="14%" bgcolor="$table_title_bg" style="$table_title_style" colspan="2"><strong>Net Amount Due</strong></th>
                                    ...
                                    <tr>
                                        <th  width="2%" bgcolor="$table_title_bg" style="$table_title_style" >SI</th>
                                        <th  width="29.3%"  bgcolor="$table_title_bg" style="$table_title_style" >Description</th>
                                        <th  width="5%" bgcolor="$table_title_bg" style="$table_title_style" >Qty</th>
                                        <th  width="5%" bgcolor="$table_title_bg" style="$table_title_style" >Unit</th>
										<th  width="6.9%" bgcolor="$table_title_bg" style="$table_title_style" >Rate</th>
                                        <th  width="6.9%" bgcolor="$table_title_bg" style="$table_title_style" >Amount</th>
                                        <th  bgcolor="$table_title_bg" style="$table_title_style" >Executed Work</th>
                                        <th  bgcolor="$table_title_bg" style="$table_title_style" >Amount</th>
                                        <th  bgcolor="$table_title_bg" style="$table_title_style" >Executed Work</th>
                                        <th  bgcolor="$table_title_bg" style="$table_title_style" >Amount</th>
                                        <th  bgcolor="$table_title_bg" style="$table_title_style" >Executed Work</th>
										<th  bgcolor="$table_title_bg" style="$table_title_style" >Net Amount</th>
