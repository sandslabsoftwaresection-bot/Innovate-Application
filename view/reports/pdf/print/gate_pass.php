...
$html = <<<EOD
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" id="main_table">
                ...
                <td style="padding-left: 10px; padding-right: 10px">
                    <table width="100%" border="1px" cellspacing="0" cellpadding="5" style="border-collapse: collapse;">
                        <tbody>
							...
							<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;width:350px;"> <strong>Description</strong></td>
							<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;width:100px"><strong>Qty</strong></td>
							<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;width:100px"><strong>Unit</strong></td>
						   </tr>
						   <tr>
							...
							<td style="text-align: center;font-size:15px;width:350px;border-right:1px solid black;border-left:1px solid black;"><strong ></strong></td>
							<td  style="text-align: center; font-size:15px;width:100px;border-right:1px solid black;"><strong></strong></td>
							<td  style="text-align: center; font-size:15px;width:100px;border-right:1px solid black;"></td>
						   </tr>
                            $content
                        </tbody>
                    </table>
	...
	<div class="signature-area" style="position: absolute;
                bottom: 50px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" valign="middile">
				  <tbody>
					<tr>
					...
					<tr>
					<td>Vehicle No :<strong>$vehicle_no</strong></td>
					</tr>
					<tr>
					<td>Driver :<strong>$driver_name</strong></td>
					</tr>
