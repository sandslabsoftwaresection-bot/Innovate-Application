...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// set bacground image
		$img_file = K_PATH_IMAGES.'webinar_python_blank.jpg';
...
$sql = "SELECT name, email, name_hindi,certificate_code,status FROM internship_details where email = 'shaniyacky2004@gmail.com'";
