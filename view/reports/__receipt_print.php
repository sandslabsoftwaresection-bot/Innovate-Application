	        ...
	        <td colspan="2" style='padding:1px'><table width="100%" border="0" cellspacing="0" cellpadding="5">
	          <tbody>
	            ...
	            <tr>
	              ...
	              <td colspan="5" align="left" valign="middle" style="text-align: left">Varified : <?PHP echo $verified_by;?></td>
	              <td colspan="2" align="left" valign="middle" style="text-align: left">Amount BD : <strong><?PHP echo $total_amount;?></strong></td>
                </tr>
	            <tr>
