  ...
  <tbody>
    <tr >
      <td style="padding-left: 10px;padding-right: 10px"><table width="800" border="0" cellspacing="0" cellpadding="5">
        <tbody>
          <tr>
            <td width="50%" rowspan="3" align="center" style="text-align: center"><img src="logo.png" width="238" height="49" alt=""/></td>
          ...
          <tr>
            <td align="left" valign="top"><table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                ...
                <tr>
                  <td width="372">Project : <strong>Villa Project for Govt Employees.</strong></td>
                  </tr>
                <tr>
...
Fax : <?PHP echo $fax; ?></td>
            <td align="left" valign="top"><strong>from,<br>
              incomDECK</strong><br>
      ...
      <td style="padding-left: 10px;padding-right: 10px"><table width="773px" border="0" cellspacing="0" cellpadding="5">
        <tbody>
          <tr>
            ...
            <td bgcolor="#0079DD" style="text-align: right; color: #FFFFFF;"><strong>Dis %</strong></td>
            <td bgcolor="#0079DD" style="text-align: right; color: #FFFFFF;"><strong>Dis Amount</strong></td>
            <td bgcolor="#0079DD" style="text-align: right; color: #FFFFFF;"><strong>Tax %</strong></td>
            <td bgcolor="#0079DD" style="text-align: right; color: #FFFFFF;"><strong>Net Amount</strong></td>
          </tr>
          <?PHP 
                $ctr = 1;
                $amt=0;
           ...
           <tr>
            ...
            <td style="text-align: center"><?PHP echo $row['discount_precentage'];?></td>
          ...
          <tr>
            <td colspan="6" style="text-align: left;text-decoration: underline;">&nbsp;</td>
          </tr>
          <tr>
