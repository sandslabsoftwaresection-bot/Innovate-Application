  ...
  <tbody>
   ...
   <!--       </tr>-->
    ...
    <tr style="border-bottom: 1px solid gray;">
            ...
            <td style="text-align: right" colspan="2"><strong><?PHP echo number_format($received_amount,3);?></strong></td>
          </tr>
          	<tr style="border-bottom: 1px solid gray;">
            <td style="text-align: center">&nbsp;</td>
            ...
            <td style="text-align: right" colspan="2"><strong><?PHP  echo number_format($retention_amount,3);?></strong></td>
          </tr>
          	<tr style="border-bottom: 1px solid gray;">
            <td style="text-align: center">&nbsp;</td>
