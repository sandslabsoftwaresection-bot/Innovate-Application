    ...
    <tr >
      <td style="padding-left: 10px;padding-right: 10px">
        ...
        <tbody>
          ...
          <tr>
            <td align="left" valign="top" style="padding-top: 0px;"><p><strong>  Quotation No : <strong><?PHP echo $invoice_number; ?></strong><br><br>
              <strong><?PHP echo $company_name; ?></strong><br>
                ...
                <strong>VAT NO : <?PHP echo $company_vat_no;?></strong></p>
              </td>
