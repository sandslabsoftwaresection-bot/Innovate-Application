...
.strikethrough {
     ...
     <style>
        ...
        .table-responsive::-webkit-scrollbar-thumb {
            background-color: #5d2cb4; /* Set the color of the scrollbar thumb */
    ...
    <style>
        #tbl_salary_consolidate_list td.emp_name {
            text-align: left;
...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/salary_consolidate_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/salary_consolidate_body_normal.php')?>
        <!-- content page ends -->
 ...
 <!--   <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>-->
    ...
    <script src="../httpdocs/user_js/salary_consolidate_normal.js"></script>
