...
<head>
    ...
    <link id="theme" rel="stylesheet" href="css/purplesidebar.css" type="text/css">
     ...
     <link rel="stylesheet" type="text/css" href="vendor/dropify/css/dropify.min.css">
...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/inventory_category_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/inventory_category_body.php')?>
        <!-- content page ends -->
 ...
 <!--<script src="vendor/dropify/js/dropify.min.js"></script>-->
   ...
   <!-- User script file -->
    ...
    <script src="../httpdocs/user_js/inventory_category.js"></script>
    
    <script src="../httpdocs/user_js/autocomplete.js"></script>
