...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/salary_head.php');?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/salary_body_new.php');?>
        <!-- content page ends -->
    ...
    <script src="../httpdocs/user_js/salary_new.js"></script>
...
<script src="../httpdocs/user_js/log_out_script.js"></script>
    ...
    $(document).ready(function() {    
                ...
                // var invoice_view_list_table = $('#list_of_accounts_head').DataTable( {searching: false, paging: false, info: false,"ordering": false});
                // $('#list_of_accounts_head').removeClass( 'display' ).addClass('table table-striped table-bordered');
    ...
    //     //alert(selectedValue);
    //     var v_emp_ids=$("#div_employee_select option:selected").val();
