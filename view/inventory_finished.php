...
@media print {
  #print_but,#export_excel_but, .sidebar-left, .main-header, #list_pr_sidenav {
    display: none;
  }
}
...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page -->
       <?PHP include('templates/inventory_finished_body.php')?>
        <!-- content page ends -->
    ...
    <script src="../httpdocs/user_js/inventory_finished.js"></script>
