...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/invoice_head_v3.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/invoice_body_v3.php')?>
        <!-- content page ends -->
    ...
    <script src="js/main-with-style-switcher.js"></script>
     <script src="../httpdocs/user_js/invoice_new_v3.js"></script>
    ...
    function openNavR() {
      ...
      // document.getElementById("mySidenavR").style.visibility="visible";
