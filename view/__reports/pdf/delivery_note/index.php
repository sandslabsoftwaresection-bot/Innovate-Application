                ...
                $result = mysqli_query($conns,"select * from delivery_note_child_tbl where delivery_note_no = '".$_GET['delivery_note_number']."'");
                     while($row=mysqli_fetch_assoc($result)) {
                         ...
                         if($row['discount_precentage']!=0)
                         {
                          ...
                          $content = $content.'  <td bgcolor="#f2f2f2" style="text-align: left"><strong><u>'.trim($row["description"]).'</u></strong>'.$row["description"].'</td>';
                          ...
                          $content = $content.'  <td bgcolor="#f2f2f2" style="text-align: right">'.$row["remarks"].'</td>';
                            ...
                            <tr>
                                <td align="left" valign="top" style="padding-top: 0px;">
                                    <p>
                                        ...
                                        <strong>$contact_address_2 </strong><br>
                                        <strong>TEL : $telephone_no / , FAX : $fax </strong><br>
                                    </p>
                                </td>
                                <td align="left" valign="top">
                                    <table width="100%" cellspacing="0" cellpadding="5">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 10px">
                    <table width="100%" border="1px" cellspacing="0" cellpadding="5" style="border-collapse: collapse;">
                        <tbody>
                            <tr>
                                <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF; font-size: 12px; width: 5%">
                                    <strong>SL</strong>
                                </td>
                                <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF; font-size: 12px; width: 50%">
                                    <strong>Description</strong>
                                </td>
                                <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF; font-size: 12px; width: 10%">
                                    <strong>Qty</strong>
                                </td>
                                <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF; font-size: 12px; width: 10%">
                                    <strong>Unit</strong>
                                </td>
                                <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF; font-size: 12px; width: 20%">
