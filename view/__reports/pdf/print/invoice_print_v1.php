...
function convertThreeDigitGroupToWords($number) {
    ...
    while($row=mysqli_fetch_assoc($result)) {
        ...
        $invoice_number = $row['invoice_real_no'];
                     ...
                     while($row=mysqli_fetch_assoc($result)) {
						 ...
						 else if($row['purchase_amount_pr']==0.00)
						 {
							 ...
							 $v_rate_amt=$row['rate'];
                                            ...
                                            $content .=  '<td bgcolor="#E5E5E5" style="text-align: right;border: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2">'.number_format($row['net_amount'],3).'</td>';
                                            $content .='</tr>';
						                    $amt=$amt+ $row['amount'];
                                       ...
                                       $content .=' </tr>';
										    ...
										    $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2"><strong>Total Amount (Ex-VAT)</strong></td>';
                                              
                                             // $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1">&nbsp;</td>';
                                              $content .='<td style="text-align: right;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"><strong>'.$sub_total.'</strong></td>';
                                            $content .='</tr>';
											if($discount_amount!=0){
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"colspan="2">Discount</td>';
                                             // $content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
											  ...
											  if ($discount_type == "BD") {
													...
													if ($number[1] == '000') {
														...
														$content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1"></td>';
													...
													$content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1">'.$disc.'%</td>';
											...
											if($discount_amount!=0){
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2"><strong>Net Amount (Ex-VAT)</strong></td>';
                                              //$content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
                                              $content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1">&nbsp;</td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2" bgcolor="#E5E5E5">Gross Value of work BD </td>';
											  
                                              //$content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"></td>';
                                              $content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1"></td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2" bgcolor="#E5E5E5">Less Previous Bill received BD</td>';
                                              //$content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"></td>';
                                              $content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1"></td>';
											...
											if($previous_bill_amount!=0){
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2" bgcolor="#E5E5E5"><strong>Net Amount due to date</strong></td>';
                                              //$content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
                                              $content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1">&nbsp;</td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2" bgcolor="#E5E5E5">Less Retention BD</td>';
                                             // $content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"></td>';
											 if($v_retention!=0){
											...
											if($v_rec_amt!=0){
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2" bgcolor="#E5E5E5">Less Advance received BD</td>';
                                             // $content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"></td>';
											 if($v_recied_pr!=0){
                                              $content .='<td bgcolor="#E5E5E5" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"colspan="1">'.$v_recied_pr.'%</td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2"><strong>Grand Total (Ex-VAT)</strong></td>';
                                              //$content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
                                              $content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1">&nbsp;</td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2">Tax (VAT) 10%</td>';
                                              //$content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
                                              $content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1"></td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td style="border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2"><strong>Total Amount in Due BD</strong></td>';
                                             // $content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;">&nbsp;</td>';
                                              $content .='<td style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;" colspan="1">&nbsp;</td>';
                                            ...
                                            $content .='<tr>';
                                              $content .='<td colspan="4" style="text-align: center;border-bottom: 1px solid #C0C0C0;border-collapse: collapse;"><strong>( '.$words.'&nbsp;Bahraini Dinar only)</strong></td>';
                                            $content .='</tr>';
                                            $content .='<tr>';
                                              $content .='<td colspan="4" style="text-align: center">&nbsp;</td>';
                                            $content .='</tr>';
...
<table width="100%" border="0" cellpadding="5" >
  <tbody>
    <tr>
      <td colspan="3">&nbsp;</td>
      <td colspan="3" style="padding:15px;text-align: center; background-color: #0079dd; color: white; font-size: 25px;">TAX INVOICE</td>
    </tr>
    <tr>
...
<strong>&nbsp;VAT NO : $company_vat_no</strong>
      ...
      INVOICE NO:<strong>$invoice_real_no</strong><br>
      Date :<strong>$invoice_date</strong><br>
      Quotation Ref :<strong>$quotation_no_child</strong><br>
    ...
    <tr>
      ...
      <td width="60%" bgcolor="#0079DD" style="text-align: center ; color: #FFFFFF;border: 1px solid #C0C0C0;border-collapse: collapse;">Discription</td>
      <!--<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;border: 1px solid #C0C0C0;border-collapse: collapse;">Qty</td>
	   ...
	   <td width="10%" bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;border: 1px solid #C0C0C0;border-collapse: collapse;">Qty / %</td>-->
      <td width="30%" bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;border: 1px solid #C0C0C0;border-collapse: collapse;" colspan="2">Amount</td>
    </tr>
    $content
