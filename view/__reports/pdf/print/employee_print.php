...
$pdf->setTitle('SAPPHIER/EMPLOYEE_REPORT');
...
$pdf->AddPage();
             ...
             $ctr = 1;
              ...
              if($type==1)
              {
                $result_project_repport = mysqli_query($conns,"select * from emp_registration_tbl");  
              }
              else if($type==2){
                  $result_project_repport = mysqli_query($conns,"select * from emp_registration_tbl where status='Active'"); 
              }
              else if($type==3){
                  $result_project_repport = mysqli_query($conns,"select * from emp_registration_tbl where status='Deactive'"); 
              }
                ...
                while($row=mysqli_fetch_assoc($result_project_repport)) {
                    ...
                    $dpmt_name=trim($row['dpmt_name']);
                     $contact_no=$row['contact_no'];
                                ...
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$employee_Name.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$employee_id.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$join_date.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$division_name.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$dpmt_name.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$cpr.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$passport_no.'</td>';
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$contact_no.'</td>';
                                $content .='</tr>';	
  ...
  <tbody>
        ...
        <tbody>
          <tr>
            ...
            <td align="right" valign="top" style="background-color:red;" >
					...
					<tbody>
						<tr >
						  <td style="text-align: center; color: #FFFFFF; font-size: 26px; " bgcolor="$table_title_bg">EMPLOYEE REPORT</td>
						</tr>
   ...
   <tr>
      <td>
        ...
        <tbody>
          <tr >
            <td width="4%" bgcolor="$table_title_bg" style="$table_title_style"><strong>SI</strong></td>
            <td width="16%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Employee Name</strong></td>
              <td width="12%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Employee ID</strong></td>
              <td width="9%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Joining Date</strong></td>
            <td width="14%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Division</strong></td>
            <td width="14%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Department</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>CPR</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Passport No</strong></td>
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Contact No</strong></td>
          </tr>  
