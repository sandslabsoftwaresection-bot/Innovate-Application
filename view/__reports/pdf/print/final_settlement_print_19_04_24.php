    ...
    <tr style="padding: 0px;">
      <td colspan="4" style="padding: 0px;">
			...
			<table width="100%" cellpadding="3" border="1" style="border-collapse: collapse; text-align: right;">
		  		...
		  		<tr>
				  <td colspan="6" align="center" bgcolor="#09037f" style="color: white;"><b>Final Settlement Summary</b></td>
				</tr>
				<tr>
				  <td align="center" style="$border_colour">Type</td>
				  <td align="center" style="$border_colour">Months</td>
				  <td align="center" style="$border_colour">leave Days</td>
				  <td align="center" style="$border_colour">Rate</td>
				  <td align="center" style="$border_colour">Amount </td>
				  <td align="center" style="$border_colour">Net Amount </td>
				</tr>
				<tr>
				  ...
				  <td align="center" style="$border_colour">$travel_days</td>
				  <td align="center" style="$border_colour">$travel_allo_rate /hrs</td>
				...
				<tr>
				  ...
				  <td align="center" style="$border_colour">$total_months</td>
				  <td align="center" style="$border_colour">$indemnity_days</td>
				  <td align="center" style="$border_colour">$indemnity_rate /hrs</td>
				  <td align="right" style="$border_colour">$indemnity_amt</td>
				   
				</tr>
				<tr>
				  <td colspan="6" align="left" style="$border_colour">Note $note</td>
				  
				</tr>
				<tr>
				  <td colspan="6" align="left" style="$border_colour">This is a system-generated salary slip; no signature or seal is required. </td>
				</tr>
				<tr >
				  <td colspan="6" align="right" style="$border_colour">Authorized Signatory </td>
			    </tr>
		  </table>
