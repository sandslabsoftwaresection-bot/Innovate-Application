...
$pdf->AddPage();
      ...
      $result = mysqli_query($conns, "SELECT *, DATE_FORMAT(date_of_entry, '%d-%m-%Y') as date_of_entry FROM tbl_cashbook WHERE date_of_entry BETWEEN '".$_GET['v_start_date']."' AND '".$_GET['v_end_date']."' ORDER BY date_of_entry DESC");
//echo "SELECT *, DATE_FORMAT(date_of_entry, '%d-%m-%Y') as date_of_entry FROM tbl_cashbook WHERE date_of_entry BETWEEN '".$_GET['v_start_date']."' AND '".$_GET['v_end_date']."' ORDER BY date_of_entry DESC";
        $income_rows = [];
        $expense_rows = [];
...
foreach ($result as $row_result) {
    if ($row_result['status'] == 'Debit') {
        ...
        $content_expense .= '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['date_of_entry'].'</td>';
        $content_expense .= '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['description'].'</td>';
        $content_expense .= '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['debit'].'</td>';
        $content_expense .= '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['notes'].'</td>';
        $content_expense .= '</tr>';
        $exp_total = $exp_total +number_format((float)$row_result['debit'], 3, '.', '')  ;
         $ctr++;
    } else {
        ...
        $content_income .= '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['date_of_entry'].'</td>';
        $content_income .= '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['description'].'</td>';
        $content_income .= '<td style="text-align: right;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['credit'].'</td>';
        $content_income .= '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$row_result['notes'].'</td>';
        $content_income .= '</tr>'; 
        $income_total= $income_total + number_format((float)$row_result['credit'], 3, '.', '');
        $ctr1++;
    }
...
<table width="100%" border="0" cellspacing="0"   id="main_table" style="$table_background.$table_border">
				...
				<table width="100%"  cellspacing="0" cellpadding="5">
					<tbody>
						<tr >
						  ...
						  <td width="70%" style="text-align: right; color: #FFFFFF; font-size: 24px;" bgcolor="$table_title_bg">CASH BOOK STATEMENT</td>
						</tr>
            ...
            <td align="left" >
              ...
              <tbody>
                <tr style="text-align: right;">
                  <td style="font-size: 18px;">Cash Balance : <strong>$invoice_date</strong></td>
                </tr>
                <tr style="text-align: right;">
				 ...
				 <tr style="text-align: right;">
                  <td> Customer Name : <strong>$LPO_no</strong></td>
                </tr>
  ...
  <tbody>
    <tr>
      <td width="50%"><table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" style="$table_border">
        <tbody>
          <tr>
            <td colspan="5" align="center" valign="middle" style="color:red;" bgcolor="$table_title_bg" style="$table_title_style">CREDIT</td>
            </tr>
          <tr>
            ...
            <td width="30%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">Description</td>
            <td width="19%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_right';">Amount</td>
            <td width="23%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.$border_right';">Remarks</td>
          </tr>
          $content_income
        </tbody>
      </table></td>
      <td width="50%"><table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" style="$table_border">
        <tbody>
          <tr>
            <td colspan="5" align="center" valign="middle" style="color:red;" bgcolor="$table_title_bg" style="$table_title_style">DEBIT</td>
            </tr>
          <tr>
			<td width="8%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';"><strong>Sl</strong></td>
            <td width="18%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">Date</td>
            
            <td width="31%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">Description</td>
            <td width="20%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">Amount</td>
            <td width="23%" align="center" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">Remarks</td>
          </tr>
          $content_expense
        </tbody>
      </table></td>
	...
	<tr>
      <td><table width="100%" border="1" style="border-collapse: collapse;" cellpadding="5" style="$table_border">
        <tbody>
          <tr>
            <td width="58%" align="left" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';" >Total Credit</td>
            <td width="19%" align="right" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">&nbsp;$income_total</td>
  ...
  <tbody>
    <tr>
      <td width="57%" align="left" valign="middle" style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">Total Debit</td>
