...
$pdf->setTitle('SAPPHIER/PROJECT_REPORT');
             ...
             $ctr = 1;
                ...
                if($entry_type=='PassIN'){
                    $entry_type='Return';
                                ...
                                $content .=  '<td style="text-align: left;'.$valign_middle.$border_bottom.$border_left.';">'.$store_category.'</td>';
                                ...
                                $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.$quantity.'</td>';
                                $content .=  '<td style="text-align: center;'.$valign_middle.$border_bottom.$border_left.';">'.$damage_qty.'</td>';
        ...
        <tbody>
          <tr>
            ...
            <td align="right" valign="top" style="background-color:red;" >
					...
					<tbody>
						<tr >
						  <td style="text-align: center; color: #FFFFFF; font-size: 26px; " bgcolor="$table_title_bg">PROJECT REPORT</td>
						</tr>
        ...
        <tbody>
          <tr >
            ...
            <td width="10%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Date</strong></td>
              ...
              <td width="13%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Category</strong></td>
            <td width="12%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Description</strong></td>
            ...
            <td width="5%" bgcolor="$table_title_bg" style="$table_title_style"><strong>Unit</strong></td>
          </tr>  
