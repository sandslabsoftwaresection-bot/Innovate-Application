								...
								while($child_row=mysqli_fetch_assoc($pr_child_table)) {
									   if($child_row['rate']=="" || $child_row['rate']=="0.000")
										 ...
										 else
										 {
											...
											$content=$content.'<td bgcolor="#f2f2f2" style="text-align: center">'.$child_row['description'].'</td>';
											$content=$content.'<td bgcolor="#f2f2f2" style="text-align: center">'.$child_row['quantity'].'</td>';
											$content=$content.'<td bgcolor="#f2f2f2" style="text-align: center">'.$child_row['unit'].'</td>';
											$content=$content.'<td bgcolor="#f2f2f2" style="text-align: center">'.number_format($v_rate, 3).'</td>';
											$content=$content.'<td bgcolor="#f2f2f2" style="text-align: center">'.$v_tax.'</td>';
											$content=$content.'<td bgcolor="#f2f2f2" style="text-align: center">'.number_format($v_amount ,3).'</td>';
										    $content=$content.'</tr>';
						                    $amt = $amt+$v_amount;
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" id="main_table">
        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top">
                                    <table width="100%" cellspacing="0" cellpadding="5">
                                        <tbody>
                                            <tr>
                                                <td style="text-align: center; color: #FFFFFF; font-size: 26px; font-family: 'Century Gothic';width:300px;" bgcolor="#0079DD">
                                                    PURCHASE RECIEVED
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td align="left" valign="top" style="padding-top: 0px;">
                                    <P>
										...
										<strong>PO Box :$city</strong><br>
                                        <strong>TEL :$contact_phone</strong><br>
                ...
                <td style="padding-left: 10px; padding-right: 10px">
                    <table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse;">
                        <tbody>
											...
											<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;width:140px;"> <strong>Description</strong></td>
											...
											<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;width:100px;"><strong>Rate</strong></td>
											<td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;width:100px;"><strong>Tax (VAT)</strong></td>
		   ...
		   <div class="signature-area">
						<table width="100%" border="0" cellspacing="0" cellpadding="5" style="" id="left" align="middile">  
						  <tbody>
							<tr>
