...
$pdf->AddPage();
             ...
             $ctr = 1;
                ...
                $result_project_repport = mysqli_query($conns,"select * from emp_registration_tbl where join_date between '".$startDate."' and '".$endDate."'");  
                    //   echo "select * from emp_registration_tbl where join_date between '.$startDate.' and '.$endDate.'";
