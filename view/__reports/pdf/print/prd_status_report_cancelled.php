...
$pdf->AddPage();
            ...
            // echo $startDate;
                $result_project_repport = mysqli_query($conns,"SELECT COUNT(local_po_number) AS po_count, 
                        ...
                        ) and local_po_status!='Cancelled' and company_id IN (".$_GET['supplier'].") and cancel_on_demand='Deactive' and (DATE(local_po_date) BETWEEN DATE('".$startDate."') AND DATE('".$endDate."'))
                ...
                while($row=mysqli_fetch_assoc($result_project_repport)) {
                    ...
                    $result_child_1 = mysqli_query($conns,"SELECT 
                        ...
                        WHERE 
                            ...
                            AND company_id = '".$company_id."' AND cancel_on_demand='Deactive' and (DATE(local_po_date) BETWEEN DATE('".$startDate."') AND DATE('".$endDate."'))");  
          ...
          <tr>
            ...
            <td align="left" valign="top" >
				<table width="100%"  cellspacing="0" cellpadding="5">
					<tbody>
						<tr >
						  <td style="text-align: center; color: #FFFFFF; font-size: 26px; " bgcolor="$table_title_bg">CANCELLED REPORT</td>
						</tr>
