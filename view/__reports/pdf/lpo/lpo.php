...
$pdf->AddPage();
                ...
                $content = $content.'    <td style="text-align: right" colspan="3"><strong>';
      ...
      <td style="padding-left: 10px;padding-right: 10px">
        ...
        <tbody>
          <tr>
            ...
            <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:12px;width:30%"> <strong>Description</strong></td>
