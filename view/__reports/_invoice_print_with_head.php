...
<strong>Manama, Kingdom of Bahrain</strong><br><span style="padding-top: 0px;"><strong>TEL : <?PHP echo $telephone_no; ?></strong></span><br><span style="padding-top: 0px;"><strong>FAX : <?PHP echo $fax; ?></strong></span><br><span style="padding-top: 0px;"><strong>VAT NO : <?PHP echo $company_vat_no; ?></strong></span></td>
            <td align="left" valign="top" ><table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                ...
                <tr>
                 ...
                 <tr>
                  <td><span style="padding-bottom: 0px;"> NO: <strong><?PHP echo $invoice_number; ?></strong></span></td>
                </tr>
                <tr>
