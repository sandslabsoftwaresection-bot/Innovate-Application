...
<head>
<meta charset="utf-8">
<title>Pass In<?php echo ' - '.$pass_in_no;?></title>
<style>
 ...
 <table width="800" border="0" cellspacing="0" cellpadding="5" align="center" id="main_table">
  <tbody>
        ...
        <tbody>
          <tr>
            <td width="50%" align="left" valign="top" style="padding-bottom: 0px;">
                ...
                <tr>
                  <td><strong>Company : <?PHP echo $company_name; ?></strong></td>
                </tr>
                <tr>
		   ...
		   <td align="left" valign="top" ><table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                <tr >
                  <td style="text-align: center; color: #FFFFFF; font-size: 26px; font-family: 'Century Gothic';" bgcolor="#0079DD">PASS IN</td>
                </tr>
               <tr>
                  <td style="float: right;"><span style="padding-bottom: 0px;">Pass In No: <strong><?PHP echo $pass_in_no; ?></strong></span></td>
                </tr>
                <tr>
                  <td style="float: right;">Date : <strong><?PHP echo $pass_in_date; ?></strong></td>
                </tr>
              <!--  <tr>
      ...
      <td colspan="2" style="padding-left: 10px;padding-right: 10px">
        ...
        <tbody>
          <tr>
            ...
            <td bgcolor="#0079DD" style="text-align: center; color: #FFFFFF;font-size:15px;"> <strong>Inventory</strong></td>
               ...
               $i=0;
                ...
                ?>
                          ...
                          <tr style="border-bottom: 1px solid gray;">
                            ...
                            <td bgcolor="#f2f2f2"style="text-align: left;border-right: 1px solid black;"><?PHP echo $inventory_name;?></td>
	...
	<div class="signature-area" style="position: absolute; margin-bottom: 50px;">
			<table width="1000" border="0" cellspacing="0" cellpadding="5" align="right" style="margin-top: 50px;">
			  <tbody>
				<tr>
	...
	<div>
  <!--<span style="margin-left: 74px;margin-top: 50px;float: left;">
  Vehicle No : <?php echo $vehicle_no; ?></span>
  <span style="margin-left:-124px;margin-top: 80px;float: left;">Driver :<?php echo $driver_name; ?></span>
...
{
	var gp = "<?php echo $pass_in_no; ?>";
	var filename = "Pass In - "+gp+".xls";
