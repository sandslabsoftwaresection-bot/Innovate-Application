						  ...
						  <tr>
							...
							<td align="left" valign="top" >
								<table width="370px"  cellspacing="0" cellpadding="5">
								  <tbody>
									<tr >
									  <td style="text-align: center; color: #FFFFFF; font-size: 26px; font-family: 'Century Gothic';" bgcolor="#0079DD">FIXED INVENTORY LIST</td>
									</tr>
									<tr>
					...
					<tr>
					  <td style="padding-left: 10px;padding-right: 10px">
						...
						<tbody>
						  ...
						  <?PHP 
								$ctr = 1;
								$tbl_inventory = mysqli_query($conns, "SELECT * FROM inventory_tbl WHERE inventory_category='Fixed'");
