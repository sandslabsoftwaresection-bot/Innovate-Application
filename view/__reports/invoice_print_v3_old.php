  ...
  <tbody>
        ...
        <tbody>
          <tr>
            ...
            <td align="left" valign="top" ><table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                <tr >
                  <td style="text-align: center; color: #FFFFFF; font-size: 20px;" bgcolor="#0079DD">INVOICE </td>
                </tr>
                <tr>
      ...
      <td style="padding-left: 10px;padding-right: 10px"><table width="775px" border="0" cellspacing="0" cellpadding="5">
        <tbody>
          ...
          <?PHP 
                ...
                ?>
                          <tr>
                            ...
                            <td bgcolor="#f2f2f2" style="text-align: right"><?PHP echo $discount;?></td>
                            <td bgcolor="#f2f2f2" style="text-align: right"><?PHP echo $row['vat_percentage'];?></td>
                             <td bgcolor="#f2f2f2" style="text-align: right"><?PHP echo $vat_amount;?></td>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right"><?PHP echo $vat_amount;?></td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
           <td>&nbsp;</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="3"><strong>Grand Total</strong></td>
           ...
           <tr>
            ...
            <td>&nbsp;</td>
           <td>&nbsp;</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="3">Dis  <?PHP echo $vat; ?> </td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="2"><strong><?PHP echo number_format($dis,3);?></strong></td>
          </tr>
           ...
           <tr>
            ...
            <td>&nbsp;</td>
           <td>&nbsp;</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="3">Received Amount</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="2"><strong><?PHP echo number_format($received_amount,3);?></strong></td>
          </tr>
           <tr>
            <td style="text-align: center">&nbsp;</td>
            ...
            <td>&nbsp;</td>
           <td>&nbsp;</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="3">Retention Amount</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="2"><strong><?PHP echo number_format($retention_amount,3);?></strong></td>
          </tr>
           <tr>
            <td style="text-align: center">&nbsp;</td>
            ...
            <td>&nbsp;</td>
           <td>&nbsp;</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="3">Previous Bill Amount</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="2"><strong><?PHP echo number_format($previous_bill_amount,3);?></strong></td>
          </tr>
           ...
           <tr>
            ...
            <td>&nbsp;</td>
           <td>&nbsp;</td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="3"><strong>Balance in Due</strong></td>
            <td bgcolor="#E7E7E7" style="text-align: right" colspan="2"><strong><?PHP echo number_format($balane_in_due,3);?></strong></td>
          </tr>
          
          <tr>
            <td colspan="9" style="text-align: left; font-size:12px">Bahraini Dinars: <strong> <?PHP 
            $amt1 = str_replace(",","",$balane_in_due); 
            echo getCurrency($balane_in_due);
            
            ?> </strong> Only</td>
            </tr>
          <tr>
            <td colspan="9" style="text-align: left; font-size:12px">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="9" style="text-align: left; font-size:12px">&nbsp;</td>
          </tr>
    ...
    <tr >
      <td style="padding-left: 10px;padding-right: 10px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td width="50%" align="left" valign="top"><p>For, <?PHP echo  $print_companynamne?></p>
              <p> </p>
              <p>Signature</p></td>
            <td width="50%" align="left" valign="top"><p>Received,<br><br>
            </p>
              <p><br>
                
                Signature
                
                Name ______________________________________</p></td>
          </tr>
        </tbody>
      </table></td>
    </tr>
