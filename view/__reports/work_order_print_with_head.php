												...
												<td width="50%" align="left" valign="top" style="padding-bottom: 0px;">
													<table width="370px"  cellspacing="0" cellpadding="4">
													    <tbody>
															...
															<!--<tr>
															  <td><strong>Job No : <?PHP //echo $work_order_number; ?></strong></td>
															</tr>-->
															<tr>
												...
												<td valign="top" align="">
												    <table width="370px" cellspacing="0" cellpadding="5">
													    <tbody>
														  ...
														  <!--<tr>
															  <td><span style="padding-bottom: 0px;">Job ID: <strong><?PHP //echo $work_order_number; ?></strong></span></td>
															</tr>-->
															<tr>
															...
															<tr>
															  <td style="float: right;"><strong>Start Date : <?PHP echo $work_order_start_date; ?></strong></td>
															</tr>
															
															<tr>
															  <td style="float: right;"><strong>End Date : <?PHP echo $work_order_end_date; ?></strong></td>
															</tr>
													    <!--<tr>
							    ...
							    <td colspan="2" style="padding-left: 10px;padding-right: 10px">
								    <table width="795px" border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse;">
										<tbody>
										    ...
										    <tr>
												<td style="font-size:15px;width:20px;border-right:1px solid black;border-left:1px solid black;"><strong ></strong></td>
												<td  style="font-size:15px;border-right:1px solid black;"> <strong></strong></td>
												<td  style="font-size:15px;width:50px;border-right:1px solid black;"><strong></strong></td>
												<td  style="font-size:15px;width:50px;border-right:1px solid black;"></td>
												<td  style="center;font-size:15px;width:50px;border-right:1px solid black;">			
												...
												<td  style="font-size:15px;width:120px;border-right:1px solid black;"><strong></strong></td>
										    </tr>
										  <?PHP 
											   $i=0;
										    ...
										    <tr style="border-bottom: 1px solid gray;">
												<td bgcolor="#f2f2f2" style="border-right: 1px solid black;border-left: 1px solid #000;"><?PHP echo $i;?></td>
												<!--<td bgcolor="#f2f2f2"style="text-align: left;border-right: 1px solid black;"><?PHP //echo $description;?></td>-->
												<td bgcolor="#f2f2f2" style="border-right: 1px solid black;"><strong><?PHP echo $product_name;?></strong></td>
											   
												<td bgcolor="#f2f2f2" style="border-right: 1px solid black;"><?PHP echo $qty;?></td>
												<td bgcolor="#f2f2f2" style="border-right: 1px solid black;"><?PHP echo $unit;?></td>
												<td bgcolor="#f2f2f2" style="border-right: 1px solid black; padding: 0px;">
												<table style="height: 40px;border: 1px solid #ADADAD;border-collapse: collapse;"><tr>
												<td style="width:25%; border-left-style: hidden;"><?php if($quotation_status=='Material Received'){?><i class="fa fa-check" aria-hidden="true"></i><?php } else { echo "&nbsp"; } ?></td>
												<td style="width:25%; border-left: 1px solid black;"><?php if($quotation_status=='Fabrication completed'){ ?><i class="fa fa-check" aria-hidden="true"></i><?php } else { echo "&nbsp"; } ?><td>
												<td style="width:25%; border-left: 1px solid black;"><?php if($quotation_status=='Delivered'){?><i class="fa fa-check" aria-hidden="true"></i><?php } else { echo "&nbsp"; } ?></td>
												<td style="width:25%; border-left: 1px solid black;border-right-style: hidden;"><?php if($quotation_status=='Site fixing completed'){ ?><i class="fa fa-check" aria-hidden="true"></i><?php } else { echo "&nbsp"; } ?></td>
												</tr></table></td>
