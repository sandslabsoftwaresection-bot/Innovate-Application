	  ...
	  <table width="100%" border="0" cellpadding="5" cellspacing="0">
	    <tbody>
	      <tr>
	        ...
	        <td align="right" ><strong ><h2>DELIVERY NOTE</h2></strong></td>
          </tr>
	      <tr>
       ...
       <!--   </tr>-->
	      <tr>
	        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="5">
	          <tbody>
	            <tr>
	              <td width="14%" bgcolor="#DBDBDB"><strong>SL No</strong></td>
	              <td width="48%" align="left" valign="middle" bgcolor="#DBDBDB"><strong>Description</strong></td>
	              <td width="21%" align="center" valign="middle" bgcolor="#DBDBDB"><strong>Qty</strong></td>
	              <td width="17%" align="center" valign="middle" bgcolor="#DBDBDB"><strong>Unit</strong></td>
