  ...
  <tbody>
        ...
        <tbody>
          <tr>
            ...
            <td align="left" valign="top" ><table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                <tr >
                  <td style="text-align: center; color: #FFFFFF; font-size: 20px;" bgcolor="#0079DD">PURCHASE ORDER </td>
                </tr>
                <tr>
          ...
          <tr>
            ...
            <table width="370px"  cellspacing="0" cellpadding="5">
              <tbody>
                 <tr>
                  <td>Reference : <strong><?PHP echo $quotation_reference; ?></strong></td>
                </tr>
                <tr>
                  <td><strong><?PHP //echo $project_name; ?></strong></td>
                </tr>
                <tr>
                  <td> <strong><?PHP //echo $LPO_no; ?></strong></td>
                </tr>
              </tbody>
            </table></td>
          </tr>
    ...
    <tr >
      <td style="padding-left: 10px;padding-right: 10px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td width="50%" align="left" valign="top"><p>For, <strong><?PHP echo $print_companynamne;?></strong></p>
              <p> </p>
              <p>Signature</p></td>
