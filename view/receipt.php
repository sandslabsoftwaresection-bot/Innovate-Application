...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/receipt_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/receipt_body.php')?>
        <!-- content page ends -->
    ...
    <script src="../httpdocs/user_js/receipts.js"></script>
    ...
    //     document.getElementById("mySidenavRCancel").style.width = "800px";
    // }
