...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/purchase_req_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/purchase_req_body.php')?>
        <!-- content page ends -->
   ...
   <!-- Select2 -->
   <script src="../httpdocs/plugins/select2.min.js"></script>
   <script src="../httpdocs/plugins/select2.js"></script>
   <!-- /Select2 -->
    ...
    <script src="../httpdocs/user_js/local_po.js"></script>
	<script src="../httpdocs/user_js/purchase_req.js"></script>
