...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
      ...
      <!-- autocomplete CSS -->
    <link rel="stylesheet" href="vendor/autocomplete/easy-autocomplete.css" >
    <!--**********************************************************-->
   ...
   <style>
        ...
        #financial_summary_project_container .row > div {
            padding-left: 15px !important;
            padding-right: 15px !important;
        }
        
        #financial_summary_project_container .row {
            margin-left: 0;
            margin-right: 0;
        }
...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
         <?PHP include('templates/accounts_ledger_project_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/accounts_ledger_project_body.php')?>
        <!-- content page ends -->
    ...
    <script src="../httpdocs/user_js/account_ledger_project.js"></script>
   ...
   <script src="vendor/EasyAutocomplete-1.3.5/jquery.easy-autocomplete.min.js"></script>
     ...
     <script src="../httpdocs/user_js/autocomplete_item.js"></script>
