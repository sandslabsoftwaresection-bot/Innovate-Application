...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/intern_payment_app_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/intern_payment_app_body.php')?>
        <!-- content page ends -->
    ...
    <script src="js/main-with-style-switcher.js"></script>
     <script src="../httpdocs/user_js/intern_payment_app.js"></script>
    ...
    // $('#select_company_search').addClass('newClass');
