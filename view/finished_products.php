...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/finished_products_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/finished_products_body.php')?>
        <!-- content page ends -->
   ...
   <!-- User script file -->
    ...
    <script src="../httpdocs/user_js/finished_products.js"></script>
