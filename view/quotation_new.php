...
curl_setopt_array($curl, array(
	CURLOPT_URL => "api.open
weathermap.org/data/2.5/weather?q=bahrain,manama&appid=b3073171c40282ef72ccfc65faec0db0",
    ...
    <div class="wrapper">
      ...
      <?PHP include('templates/left_menu.php')?>
       ...
       <?PHP //include('templates/settings_chat.php')?>
        ...
        <!-- content page title -->
        <?PHP include('templates/quotation_new_head.php')?>
       
        <!-- content page title ends -->
       
        <!-- content page -->
       <?PHP include('templates/quotation_new_body.php')?>
        <!-- content page ends -->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>
    ...
    <script src="../httpdocs/user_js/quotation_new.js"></script>
    ...
    function openNavRCompany() {
        document.getElementById("mySidenavRCompany").style.width = "83%";
    }

    function closeNavRCompany() {
        document.getElementById("mySidenavRCompany").style.width = "0";
    }     
  </script>
