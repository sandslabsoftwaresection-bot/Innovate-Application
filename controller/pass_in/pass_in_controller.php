...
class gatepasscontrollerController
{
        ...
        public $actionevents,$v_ctrl_name,$company_id, $v_gate_pass_date, $company_name, $v_vehicle_no, $v_driver_name;
        ...
        public $v_attn, $v_start_date, $v_end_date;
    ...
    { 
        $array =  array();
         ...
         $array[2] = "CALL proc_generate_gate_pass('".$this->company_id."','".$this->company_name."','".$this->v_gate_pass_date."','".$this->v_vehicle_no."','".$this->v_driver_name."','".$this->v_approved_by."','".$this->v_checked_by."','".$this->v_received_by."','".$this->v_description."','".$this->v_qty."','".$this->v_unit."','".$this->v_pass_no."',@msg)";
