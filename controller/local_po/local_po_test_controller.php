...
class local_poController
{
        ...
        public $v_amt_after_discount,$v_tax_percentage,$v_net_amount,$company_id,$v_job_ids,$v_job_name,$v_prn_no,$array_table_data,$v_descValue;
    ...
    function __construct()
	{
       ...
       $this->array_table_data=$_POST['dataArray'];
        $this->v_descValue=$_POST['v_descValue'];
    ...
    { 
        ...
        //$array[0] = "CALL proc_add_local_po_main_list( '".$this->local_po_date."','".$this->company_name."','".$this->po_box."','".$this->telephone_no."','".$this->fax."','".$this->quotation_reference."','".$this->payment_terms."','".$this->local_po_number."', '".$this->description."','".$this->quantity."','".$this->unit."','".$this->rate."','".$this->amount."','".$this->v_discount_percentage."','".$this->v_amt_after_discount."','".$this->v_tax_percentage."','".$this->v_net_amount."',@msg)";
        
        // $array[0] = "CALL proc_add_local_po_main_list3( '".$this->local_po_date."','".$this->company_id."','".$this->company_name."','".$this->po_box."','".$this->telephone_no."','".$this->fax."','".$this->quotation_reference."','".$this->payment_terms."','".$this->local_po_number."', '".$this->description."','".$this->quantity."','".$this->unit."','".$this->rate."','".$this->amount."','".$this->discount_type."','".$this->v_discount_percentage."','".$this->v_amt_after_discount."','".$this->v_tax_percentage."','".$this->v_net_amount."','".$this->v_job_name."','".$this->v_prn_no."',@msg)";
         $array[0] = "CALL proc_add_local_po_main_list3( '".$this->local_po_date."','".$this->company_id."','".$this->company_name."','".$this->po_box."','".$this->telephone_no."','".$this->fax."','".$this->quotation_reference."','".$this->payment_terms."','".$this->local_po_number."', '".$this->description."','".$this->quantity."','".$this->unit."','".$this->rate."','".$this->amount."','".$this->discount_type."','".$this->v_discount_percentage."','".$this->v_amt_after_discount."','".$this->v_tax_percentage."','".$this->v_net_amount."','".$this->v_job_name."','".$this->v_prn_no."',@msg)";
        
        $array[1] = "CALL proc_list_local_po1('".$this->local_po_number."',@msg)";
        ...
        //$array[3] = "CALL proc_view_local_po_list(@msg)";
		$array[3] = "CALL proc_view_local_po_list1(@msg)";
		
        
        $array[4] = "CALL proc_view_local_po_list_between('".$this->from_date."','".$this->to_date."',@msg)";
        
        //$array[5] = "CALL proc_edit_local_po_main_list( '".$this->local_po_date."','".$this->company_name."','".$this->po_box."','".$this->telephone_no."','".$this->fax."','".$this->quotation_reference."','".$this->payment_terms."','".$this->local_po_number."', '".$this->description."','".$this->quantity."','".$this->unit."','".$this->rate."','".$this->amount."','". $this->sub_total."','".$this->less_discount."','".$this->total_amount."','".$this->vat."','".$this->balane_in_due."','".$this->main_description."','". $this->local_po_child_id."',@msg)";
        ...
        $array[12]= "SELECT company_id,company_name,contact_phone,city,fax,contact_person FROM supplier_details where company_id= ".$this->company_id." and status='Active' " ;
        
        $array[13] = "CALL proc_edit_loal_po_list1('".$this->local_po_child_id."', '".$this->description."','".$this->quantity."','".$this->unit."','".$this->rate."','".$this->amount."','".$this->discount_type."','".$this->v_discount_percentage."','".$this->v_amt_after_discount."','".$this->v_tax_percentage."','".$this->v_net_amount."',@msg)";
        
        $array[14] = "Delete from local_po_child_tbl where local_po_child_id=".$this->local_po_child_id;
        
        //$array[15] = "CALL proc_view_cancelled_local_po_list(@msg)";
        ...
        $array[17] = "UPDATE local_po_child_tbl SET quantity='".$this->quantity."', rate='".$this->rate."',amount='".$this->amount."',discount_precentage='".$this->v_discount_percentage."',discount_amount='".$this->v_amt_after_discount."',net_amount='".$this->v_net_amount."',description = '".$this->v_descValue."' WHERE local_po_child_id='".$this->local_po_child_id."'";
        $array[18] = "UPDATE  local_po_main_tbl SET sub_total='".$this->sub_total."' WHERE local_po_number='".$this->LPO_no."'";
        return $array;
    }
    function RequestAccept($FunctionEvents)
    {
        ...
        switch ($FunctionEvents)
        {
            ...
            case 'generate_local_po': 
                ...
                $SQLString = 'INSERT INTO local_po_child_tbl(`description`,item_id,category_name,category_id,item_code, `quantity`,`unit`,`rate`,`amount`,`discount_type`,`discount_precentage`,`discount_amount`,`vat_percentage`,`net_amount`) VALUES ';
				  $SQLOther = "";
			    for($i=0;$i<=sizeof($this->array_table_data)-1;$i++){
			
			      $SQLOther = $SQLOther .'("'.$this->array_table_data[$i]['item'].'","'.$this->array_table_data[$i]['itemid'].'","'.$this->array_table_data[$i]['cat_name'].'","'.$this->array_table_data[$i]['cat_id'].'","'.$this->array_table_data[$i]['item_code'].'","'.$this->array_table_data[$i]['qty'].'","'.$this->array_table_data[$i]['unit'].'","'.$this->array_table_data[$i]['rate'].'","'.$this->array_table_data[$i]['amount'].'","'.$this->array_table_data[$i]['disc_type'].'","'.$this->array_table_data[$i]['disc_pr'].'","'.$this->array_table_data[$i]['disc_amount'].'","'.$this->array_table_data[$i]['tax_pr'].'","'.$this->array_table_data[$i]['net_total'].'"),';  
                ...
                $sql = "CALL proc_add_local_po_main_list3( '".$this->local_po_date."','".$this->company_id."','".$this->company_name."','".$this->po_box."','".$this->telephone_no."','".$this->fax."','".$this->quotation_reference."','".$this->payment_terms."','".$this->v_job_name."','".$this->v_prn_no."','".$this->sub_total."','".$this->less_discount."','".$this->total_amount."','".$this->vat."','".$this->balane_in_due."','".$this->main_description."','".$SQLString."',@msg)";
            //   echo $sql;
                $this->varModelObj->ExecuteProcedure($sql);
            ...
            case 'update_lpo_child': 
                ...
                $res =$this->varModelObj->UpdateTable($var[17]);
