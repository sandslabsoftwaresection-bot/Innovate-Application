...
class delivery_noteController
{
    ...
    { 
        ...
        $array[0] = "CALL proc_add_delivery_note_main_list( '".$this->delivery_note_date.' '.$this->current_date."','".$this->company_name."','".$this->po_box."','".$this->telephone_no."','".$this->fax."','".$this->attn."','".$this->quotation_reference."','".$this->LPO_no."','".$this->delivery_note_number."', '".$this->description."','".$this->quantity."','".$this->unit."','".$this->v_quotation_child_id."','".$this->v_quotation_no."','".$this->v_rate."','".$this->v_amount."','".$this->v_discount_precentage."','".$this->v_discount_amount."','".$this->v_vat_percentage."','".$this->v_net_amount."','".$this->v_req_qty."','". $this->v_delivery_note_company_id."','". $this->v_delivery_note_project_id."','". $this->v_delivery_note_project_name."',@msg)";
        
        $array[1] = "CALL proc_list_delivery_note('".$this->delivery_note_number."',@msg)";
          
        $array[2] = "CALL proc_generate_delivery_note('".$this->delivery_note_number."','".$this->main_description."',@msg)";
      
        $array[3] = "CALL proc_view_delivery_note_list(@msg)";
