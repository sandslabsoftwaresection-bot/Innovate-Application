                            ...
                            "columns": [
								 ...
								 { "data": "qty_change", width:"10%",
								  render: function ( data, type, rows, meta ) {
											...
											var grade_edit =' <input type="number" style="border-color:#F7B1B4"  id="txt_qty_change_'+rows["quotation_child_id"]+'" name="txt_qty_change" value="'+rows["purchase_qty"]+'" style="width:100px;">';
            					 ...
            					 { "data": "supplied_amount_%", className: "text-right",render: $.fn.dataTable.render.number(',', '.', 3, '') },
            					 { "data": "discount_precentage",className: "text-right",render: $.fn.dataTable.render.number(',', '.', 3, ''),
            					    render: function ( data, type, rows, meta ){
                   ...
                   $('#tbl_delivery_note_list tbody').on('change', 'td input', function() {
					...
					if($(this).attr("name")=='txt_qty_change')
					{
						...
						if (v_txt_qty_change !== '')
						{
							...
							$('#txt_net_total_perc_'+v_quotation_child_id).prop('disabled', true);
						} 
						else 
						{
					...
					if($(this).attr("name")=='txt_net_total_perc')
					{
						...
						{
							$('#txt_qty_change_'+v_quotation_child_id).prop('disabled', true);
                ...
                $('#btn_invoice_print_without_head').click(function(){
                   ...
                   else
                   {
                       ...
                       var v_invoice_status = obj.data[0].invoice_status;	
						   ...
						   {
							   window.open("reports/pdf/print/invoice_print.php?invoice_number="+invoice_number+"&x=1","_blank"); 
                 ...
                 $('#btn_invoice_print_with_head').click(function(){
                    ...
                    else
                    {
                       ...
                       {
                          window.open("reports/pdf/print/invoice_print.php?invoice_number="+invoice_number+"&x=0","_blank"); 
