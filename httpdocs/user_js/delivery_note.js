$(document).ready(function(){
               ...
               function formatDate(date) {
                 ...
                 load_company_select_box('div_company_select','select_company');
                   ...
                   $("#div_company_select").change(function() {
                    ...
                    $.post("../controller/quotation/quotation_controller.php",{action:'select_company_details',v_company_id:company_id},function(result,status){
                                ...
                                $("#txt_delivery_note_po_box").val(obj.data[0].city);
                 ...
                 $("#div_select_quotation_combo").change(function(){
                    ...
                    var quotation_no=$("#txt_delivery_note_quotation_ref").val(quotation_no);
                ...
                //  $('#list_of_delivery_notes tbody').on('dblclick', 'tr', function(){
                //         var $row = $(this).closest('tr');
                //         var data = delivery_note_view_list_table.row($row).data();
                //         v_delivery_note_number  = data.delivery_note_number;
                ...
                //          $("#txt_delivery_note_all_description").val(editorData);
            ...
            //     if(parseInt(v_req_quantity) < parseInt(delivered_qty))
            //     {
            //          $.toast({
            //                     heading: 'Error',
            //                     text: 'Delivered quantity is grater than required quantity',
            //                     showHideTransition: 'slide',
            //                     icon: 'error'
            //                 }); 
                            
            //         $("#txt_reissue_qty").val(v_req_quantity)  ;      
            //     }
           ...
           $("#btn_reissue_qnty").click(function(){
                ...
                function load_data_to_grid_delivery_note_list_print(delivery_note_no)
                 {
                  ...
                  function cancel_delivery_item_list(v_delivery_note_child_id)
                  {
                   ...
                   $('#btn_generate_delivery_note').click(function(){
                    ...
                    //var v_delivery_note_all_description=$("#txt_delivery_note_all_description").val();
                    
                  
                       $.post("../controller/delivery_note/delivery_note_controller.php",{action:'generate_delivery_note',v_delivery_note_no:v_delivery_note_no,v_delivery_note_all_description:v_delivery_note_all_description
                                }
            ...
            $('#btn_edit_delivery_note').click(function(){
                   ...
                   // var v_delivery_note_description=$('#txt_delivery_note_description').val();
                    
                   
                    // var v_delivery_note_all_description=$("#txt_delivery_note_all_description").val();
                    // var v_delivery_note_sub_total=pageTotal1;
                 // alert(v_delivery_note_company_name+'----'+v_delivery_note_po_box+'------'+v_delivery_note_contact_no+'-----'+v_delivery_note_fax+'_-------'+v_delivery_note_attn+'-------'+v_delivery_note_date+'--------'+v_delivery_note_quotation_ref+'_--------'+v_delivery_note_lpo_no+'__-----'+v_delivery_note_all_description);
                    ...
                    {         
                         $.post("../controller/delivery_note/delivery_note_controller.php",{action:'edit_delivery_note',v_delivery_note_company_name:v_delivery_note_company_name,v_delivery_note_po_box:v_delivery_note_po_box,v_delivery_note_contact_no:v_delivery_note_contact_no,v_delivery_note_fax:v_delivery_note_fax,v_delivery_note_attn:v_delivery_note_attn,v_delivery_note_no:v_delivery_note_no,v_delivery_note_date:v_delivery_note_date,v_delivery_note_quotation_ref:v_delivery_note_quotation_ref,v_delivery_note_lpo_no:v_delivery_note_lpo_no,v_delivery_note_no:v_delivery_note_no,v_delivery_note_all_description:v_delivery_note_all_description,v_delivery_note_child_id:v_delivery_note_child_id
                                }
                                , function(result,status)
                                {
