                     ...
                     if(v_discount_percentage>0)
                      {
                       ...
                       var discount_amount=parseFloat(v_quotation_amount)*(parseFloat(discount_percentage)/100);
                       var amt_after_discount=parseFloat(v_quotation_amount)-parseFloat(discount_amount);
                       $('#txt_amt_after_discount').val(amt_after_discount);
                       $('#txt_net_amount').val(amt_after_discount);
                     
                      }
                      else if((v_discount_percentage) <= 0 && (v_quotation_amount > 0))
                      {
                        
                        $('#txt_discount_percentage').val(0.00);  
                        $('#txt_amt_after_discount').val(v_quotation_amount);  
                      }
                      
                      var v_tax_percentage= $('#txt_tax_percentage').val();
                      if(v_tax_percentage>0)
                      {
                  ...
                  $('#txt_quotation_quantity').change(function(){
                   ...
                   $('#txt_tax_percentage').change(function(){
                      ...
                      // alert(amt_after_discount);
                       ...
                       var tax_percentage= $('#txt_tax_percentage').val();
                       var tax_amount=parseFloat(quotation_amount)*(parseFloat(tax_percentage)/100);
                       var amt_after_tax=(parseFloat(quotation_amount)+parseFloat(tax_amount)).toFixed(3);
                       $('#txt_net_amount').val(amt_after_tax);
                            ...
                            "columns": [
					          ...
					          { "data": "quotation_main_id" ,
                                          ...
                                          render: function ( data, type, rows, meta ) {
                									...
                									str_active_status_view = ' <button type="button" class="btn btn-sm btn-danger mr-2" onclick="openNavR()" id="delete_quotations" name="delete_quotations" ><i class="material-icons ">delete</i></button>';
            ...
            function edit_current_data()
                ...
                $('#btn_edit_quotation').click(function(){
                    ...
                    {         
                         ...
                         v_quotation_all_description:v_quotation_all_description,v_quotation_child_id:v_quotation_child_id,v_project_name:v_project_name,v_project_id:v_project_id,v_introduction_name:v_introduction_name,v_introduction_id:v_introduction_id,v_quotation_sub_total:v_quotation_sub_total
                                }
                                , function(result,status)
                                {
