$(document).ready(function(){
	...
	let lbl_vat_percentage=0;
                ...
                var v_but_interim_gen = $( '#btn_intern_payment_application' ).ladda();
				...
				// var invoice_details_list_table = $('#tbl_invoice_details_list').DataTable( {searching: false, paging: false, info: false,"ordering": false});
				...
				$('#div_company_select_forview').load('templates/compant_combo_load.php');
                         ...
                         $.post("../controller/invoice/new_invoice_controller.php",{action:'select_intern_pending_data',v_invoice_no:v_invoice_number},function(result,status){
                               ...
                               // $('#txt_hidden_discount_type').val(obj.data[0].discount_type);
                                ...
                                $('#txt_invoice_project_id').val(obj.data[0].project_id) ;
                                                     $("#lbl_discount").html("");
                                                    $("#lbl_net_amount_exvat").html("");
                                                        $("#lbl_vat_perc").html("");
                                                         $("#lbl_vat_amt").html(""); 
                                                      $("#lbl_gross_amt_bd").html("");
                                                      $("#lbl_discount_perc").html("");
                                   ...
                                   if(status=="success")
                                   {
                                       ...
                                       $('#div_project_select_combo option').map(function () {
                                             ...
                                             if(status=="success")
                                               {
                                                   ...
                                                   $('#div_select_quotation_combo option').map(function () {
                                                    ...
                                                    $.post('../controller/invoice/new_invoice_controller.php',{action:'select_total_discount_amount',v_quotation_no : obj.data[0].quotation_reference},function(result,status){
                                                         if(status=='success')
                                                         {
                                           
                                                        var obj= jQuery.parseJSON(result);
                                                    
                                                     var lbl_vat_percentage = parseFloat(obj.data[0].tax_content).toLocaleString("en-IN", { minimumFractionDigits: 0, maximumFractionDigits: 0 });
													  ...
													  $("#table_vat_perc").html(lbl_vat_percentage+'%');
														 ...
														 var vat_amount=((parseFloat(v_previous_bill)*parseFloat(lbl_vat_percentage))/100).toFixed(3);
										var vat_amount_for_table=parseFloat(vat_amount).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });		 
														...
														$("#txt_discount_amount_qt").val(lbl_disc);
														$('#div_discount_amount_type option').map(function () {
														if ($(this).text() == $.trim(obj.data[0].discount_type)) return this;
														}).attr('selected', 'selected');
														var for_table_gross_amt_due=$("#table_gross_amount_due").html();
													for_table_gross_amt_due=parseFloat(for_table_gross_amt_due.replace(/,/g, ''));
														var v_discount_amount_type=$("#div_discount_amount_type option:selected").val();
														
														  if(v_discount_amount_type=='%')
														  {
															 var v_discount_amount=((parseFloat(for_table_gross_amt_due)*parseFloat(lbl_disc))/100).toFixed(3);  
														  }
														  if(v_discount_amount_type=='BD')
														  {
															  var v_discount_amount=lbl_disc;
														  }
														  var disc_prc_for_table=parseFloat(lbl_disc).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
														  ...
														  var v_lbl_net_balance=$("#txt_invoice_net_balance_due").val();
														  var tbl_final=(parseFloat(v_lbl_net_balance)-parseFloat(v_discount_amount)).toFixed(3); 
														  $("#txt_invoice_net_balance_due").val(tbl_final);table_gross_amount_due
														  
														  var net_amt_due_tbl=(parseFloat(for_table_gross_amt_due)-parseFloat(v_discount_amount)).toFixed(3); 
														  var net_amt_due_tbl_for_table=parseFloat(net_amt_due_tbl).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });	
										
									//	var tbl_final_for_table=parseFloat(tbl_final).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });		  
														  $("#table_net_amount_due").html(net_amt_due_tbl_for_table);
														  var vat2=((parseFloat(net_amt_due_tbl)*parseFloat(lbl_vat_percentage))/100).toFixed(3);
														  ...
														  var table_total2=(parseFloat(net_amt_due_tbl)+parseFloat(vat2)).toFixed(3);
                               ...
                               if(obj.data[0].invoice_against=="2")
                                ...
                                $("#invoice_no_head").html(obj.data[0].invoice_number);
                                 $('#btn_generate_invoice' ).show();
                                  $('#btn_intern_payment_application' ).show();
                            // $('#update_invoice_list' ).hide();
                                 $('#update_all_invoice_list' ).show();
                 ...
                 function load_data_to_grid_invoice_list(invoice_no)
                 {
                     ...
                     invoice_list_table = $('#tbl_invoice_list').DataTable( {
                      ...
                      if(v_discount_amount_type=='BD')
                      {
                           ...
                           v_previous_bill=(parseFloat(pageTotal1)-(parseFloat(v_received_amount)+parseFloat(v_retention_amount)+parseFloat(v_discount_amount))).toFixed(3);
                            ...
                            "columns": [
            					 ...
            					 { "data": "cumulative_percentage",className: "text-center",render: $.fn.dataTable.render.number(',', '.', 3, ''),
            					    render: function ( data, type, rows, meta ){
            					        ...
            					        {
            					           // 	var grade_edit ='<div class="input-group mb-3" style="vertical-align:middle; width:100px;padding-top:9px;"> <input disabled type="number" min="0" style="font-size:12px;padding:2px;text-align:center;" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value="'+formattedValue+'" style="width:100px;"><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
            					                var grade_edit ='<div class="input-group mb-3" style="vertical-align:middle; width:100px;padding-top:9px;"> <input disabled type="number" min="0" style="font-size:12px;padding:2px;text-align:center;" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value=0 style="width:100px;"><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
            					            
            					        }
            					        else
            					        {
            					           // 	var grade_edit ='<div class="input-group mb-3" style="vertical-align:middle ; width:100px;padding-top:9px;"> <input type="number" min="0" style="font-size:12px;padding:2px;text-align:center;" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value="'+formattedValue+'" style="width:100px;"><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
								                var grade_edit ='<div class="input-group mb-3" style="vertical-align:middle ; width:100px;padding-top:9px;"> <input type="number" min="0" style="font-size:12px;padding:2px;text-align:center;" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value=0 style="width:100px;"><div class="input-group-append"> <div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
            					        }
								...
								// 		var grade_edit =' <input type="number"  min="0" id="txt_disc_total_'+rows["quotation_child_id"]+'" name="txt_disc_amount" value="'+rows["net_amount"]+'" style="width:100px;" disabled>';
								     var value1 = parseFloat(rows["total_sup_amount"]).toFixed(3);
								      var grade_edit =' <input type="number"  min="0" id="txt_disc_total_'+rows["quotation_child_id"]+'" name="txt_disc_amount" value="'+value1+'" style="text-align:right; width:100px;" disabled>';
										return grade_edit;
                            ...
                            "columns": [
            					 ...
            					 { "data": "cumulative_percentage",className: "text-center",render: $.fn.dataTable.render.number(',', '.', 3, ''),
            					    ...
            					    render: function ( data, type, rows, meta ){
            					       ...
            					       if (rows["invoice_status"] == 'Completed') {
                						 var sum=parseFloat(rows["purchase_amount_pr"]) + parseFloat(rows["supplied_amount_pr"]);
                						   
                						var formattedValue = parseFloat(sum).toFixed(3);   
										var grade_edit ='<div class="input-group mb-3" style="width:100px;padding-top:9px;">  <input style="font-size:12px;padding:2px;text-align:center;" type="number" disabled class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value="'+formattedValue+'"  ><input style="font-size:12px;padding:2px;text-align:center;" type="hidden" class="discount-input form-control" id="txt_cum_upto_this_original'+rows["quotation_child_id"]+'" name="txt_cum_upto_this_original" value="'+formattedValue+'"  ><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
								   	// var grade_edit ='<div class="input-group mb-3" style="width:100px;padding-top:9px;">  <input style="font-size:12px;padding:2px;text-align:center;" type="number" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value=0  disabled><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
								    //   console.log(rows["invoice_status"]);
								// 		return grade_edit;
            					        }
            					        else
            					        {
                						...
                						var formattedValue = parseFloat(sum).toFixed(3);   
										var grade_edit ='<div class="input-group mb-3" style="width:100px;padding-top:9px;">  <input style="font-size:12px;padding:2px;text-align:center;" type="number" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value="'+formattedValue+'"><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
								//   var grade_edit ='<div class="input-group mb-3" style="width:100px;padding-top:9px;">  <input style="font-size:12px;padding:2px;text-align:center;" type="number" class="discount-input form-control" id="txt_cum_upto_this'+rows["quotation_child_id"]+'" name="txt_cum_upto_this" value=0 ><div class="input-group-append"><span class="input-group-text" style="font-size:10px;">%</span></div></div>';
								    //   console.log(rows["invoice_status"]);
								// 		return grade_edit;
            					        }
            					        return grade_edit;
    ...
    //                             }, 0 );
                 ...
                 function load_data_to_grid_delivery_note_list_for_intern_edit(invoice_no)
                 {
                     //alert(quotation_no);
                    delivery_note_list_table.destroy();
...
// Quotation drop down select and insert the data into invoice main tbl and invoice child table
                    ...
                    // alert(lbl_amount_sum);
                     $.post('../controller/invoice/new_invoice_controller.php',{action:'select_total_discount_amount_for_qt',v_quotation_no : quotation_no},function(result,status){
                         if(status=='success')
                         {
                             ...
                             lbl_vat_percentage = parseFloat(obj.data[0].tax_content).toLocaleString("en-IN", { minimumFractionDigits: 0, maximumFractionDigits: 0 });
                              var lbl_vat_amount= parseFloat(obj.data[0].tax_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                              var lbl_gross_amt= parseFloat(obj.data[0].gross_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                              var lbl_disc=parseFloat(obj.data[0].discount_amount);
                              var lbl_net_amt_exvat=parseFloat(obj.data[0].sub_total).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
					 ...
					 //var balance_in_due=$('#table_net_amount_due').html();
					 //alert(balance_in_due);
                     //var vat_amount=((parseFloat(balance_in_due)*parseFloat(lbl_vat_percentage))/100).toFixed(3);
					 //alert(vat_amount);
					 //$('#table_tax_value').html(vat_amount);
								
                      var v_invoice_no=$("#txt_invoice_no").val();
                          if(v_invoice_no != '')
                          {
                          $.post('../controller/invoice/invoice_controller.php',{action:'delete_intern_app_child',v_invoice_no :v_invoice_no,v_quotation_no:quotation_no},function(result,status){
            ...
            // Quotation list text box item and amount change          
                   ...
                   $('#tbl_delivery_note_list tbody').on('change', 'td input', function() {
					...
					//console.log(cum_amt_total.length);
				...
				// alert(val);
					...
					if($(this).attr("name")=='txt_cum_upto_this')
					{
					 ...
					 var v_txt_net_total_perc_old = $('#txt_cum_upto_this_original'+v_quotation_child_id).val();
					 
					
					 
					 var v_change_diff = parseFloat(v_txt_net_total_perc) - parseFloat(v_txt_net_total_perc_old);
					   ...
					   var this_period_pr=parseFloat(v_txt_net_total_perc)-parseFloat(v_supplied_pr);
						...
						if(v_sum>100 || parseFloat(v_supplied_pr)>v_sum ){
							swal("Error","Check the Percentage Enterd!!","error");
						...
						if(v_txt_net_total_perc != '' && v_txt_net_total_perc>0)
						{
							...
							var v_net_total_perc1 = ((parseFloat(v_net_amount)*parseFloat(v_txt_net_total_perc))/100);
							v_net_total_perc_due = (parseFloat(v_net_total_perc1)).toFixed(3);
						//	$('#txt_net_total_perc_span'+v_quotation_child_id).html(v_sum);
							var v_net_total_perc = ((parseFloat(v_net_amount)*parseFloat(this_period_pr))/100);
           ...
           // Quotation list table save and edit option        
				 ...
				 // start of function checkInputs
				 function checkInputs()
				 {
				    var com_id= $('#select_company option:selected').val();
				    var project_id= $('#select_project option:selected').val();
				    var quatation_id= $('#select_quotation option:selected').val();
				    if(com_id==0 || project_id==0 || quatation_id==0)
				    {
				        return false;
				    }else
				    {
		...
		//update all invoice list using single button
				 ...
				 $('#update_all_invoice_list').on('click', function (){
				     //alert("clicked");
				     if (checkInputs()== true){
				         updateAllinvoiceListClick();
				     }
				     else
				     {
				        swal("Error","Company, Project, Quatation not selected","error");
				     }

							
				 });
				 // start of function updateAllinvoiceListClick
				 function updateAllinvoiceListClick()
				 {
				     				     
				     
					 var array_table_data = delivery_note_list_table.rows().data().toArray();
					// alert(delivery_note_list_table.row(i).node()).attr('invoice_status'));
				...
				//	 alert(pageTotal1);
					 ...
					 for (var i = 0; i < array_table_data.length; i++) {
							...
							var change_in_difference = parseFloat($('input[name="txt_cum_upto_this"]', delivery_note_list_table.row(i).node()).val()) - parseFloat($('input[name="txt_cum_upto_this_original"]', delivery_note_list_table.row(i).node()).val());
				...
				// 			{
							...
							array_table_data[i]['change_in_precetage'] = change_in_difference;
				...
				// 	 if(array_table_data[i]['discount_precentage'] ==0|| array_table_data[i]['discount_precentage']==0.00)
				// 			{
    ...
    //                                                 });
				...
				// 			});
				// 			}
				 }// close of function updateAllinvoiceListClick
	...
	//genrete intern payment application Invoice----------------------------------
				 $('#btn_intern_payment_application').click(function(){
                      v_but_interim_gen.ladda( 'start' );
                       ...
                       var v_invoice_balance_due=$('#txt_invoice_net_balance_due').val();
                        var v_invoice_no=$("#txt_invoice_no").val();
                        var v_interim_real_no=$("#txt_interim_real_no").val();
                    ...
                    if($.trim(v_invoice_received_amount)==""||$.trim(v_invoice_balance_due)==""||$.trim(v_invoice_all_description)=="")
                     ...
                     {
                         if($.trim(v_interim_real_no)!="")
                         {
                              $.post("../controller/invoice/new_invoice_controller.php",{action:'update_intern_payment_app',v_invoice_no:v_invoice_no,v_invoice_total_amount:v_invoice_total_amount, v_invoice_previous_bill_amount:v_invoice_previous_bill_amount, v_invoice_received_amount:v_invoice_received_amount,v_invoice_balance_due:v_invoice_balance_due, v_invoice_sub_total:v_invoice_sub_total,v_invoice_retention_amount:v_invoice_retention_amount, v_received_amount_type:v_received_amount_type,v_retention_amount_type:v_retention_amount_type,v_invoice_lpo_no:v_invoice_lpo_no
                                        }
                                        ...
                                        //   alert(result)
                                          if(result==1)
                                          {
                                            swal("Success"," Interim Updated successfully", "success"); 
                                            // $('#btn_generate_invoice').hide();
                                            // $('#btn_edit_invoice').show();
                                          // clear_all_after_generate_invoice();
                                        //   $('#txt_interim_real_no').val(obj.msg1);
                                          ...
                                          {
                                              v_but_interim_gen.ladda( 'stop' );
                                              swal("Warning"," No Changes Made", "warning");
                         ...
                         }else
                         {
                               ...
                               $.post("../controller/invoice/new_invoice_controller.php",{action:'generate_intern_payment_application',v_invoice_company_name:v_invoice_company_name,v_invoice_po_box:v_invoice_po_box,v_invoice_contact_no:v_invoice_contact_no,v_invoice_fax:v_invoice_fax,v_invoice_attn:v_invoice_attn,v_invoice_no:v_invoice_no,v_invoice_date:v_invoice_date,v_invoice_quotation_ref:v_invoice_quotation_ref,v_invoice_lpo_no:v_invoice_lpo_no,v_quotation_no:v_invoice_quotation_ref,v_project_name:v_project_name,v_project_id:v_project_id,v_invoice_company_id:v_invoice_company_id,v_invoice_no:v_invoice_no,v_invoice_vat:v_invoice_vat,v_invoice_total_amount:v_invoice_total_amount,v_invoice_received_amount:v_invoice_received_amount,v_invoice_balance_due:v_invoice_balance_due,v_invoice_all_description:v_invoice_all_description,v_invoice_sub_total:v_invoice_sub_total,v_invoice_retention_amount:v_invoice_retention_amount,v_invoice_previous_bill_amount:v_invoice_previous_bill_amount,v_discount_type:v_discount_type,v_discount_amount:v_discount_amount,v_total_discount_amount:v_total_discount_amount,v_received_amount_type:v_received_amount_type,v_retention_amount_type:v_retention_amount_type
                                        ...
                                        , function(result,status)
                                        {
                                          ...
                                          if(obj.msg=="success")
                                          {
                                            swal("Success"," Interim generated successfully..!", "success"); 
                                            // $('#btn_generate_invoice').hide();
                                            // $('#btn_edit_invoice').show();
                                           // clear_all_after_generate_invoice();
                                            console.log(obj.msg1);
                                            let original = obj.msg1; // "SI-IP-0010/25"
                                            // let parts = original.split('-'); // ["SI", "IP", "0010/25"]
                                            
                                            // if (parts.length === 3) {
                                            //     let lastPart = parts[2].split('/'); // ["0010", "25"]
                                            //     if (lastPart.length === 2) {
                                            //         let transformed = `${parts[0]}-${parts[1]}-${lastPart[1]}/${lastPart[0]}`;
                                            //         console.log(transformed); // "SI-IP-25/0010"
                                            //         $('#txt_interim_real_no').val(transformed);
                                            //     } else {
                                            //         console.error("Unexpected format in last segment:", parts[2]);
                                            //     }
                                            // } else {
                                            //     console.error("Unexpected format in original string:", original);
                                            // }
                                            ...
                                            if (parts.length === 3) {
                                                ...
                                                if (lastPart.length === 2) {
                                                    let left = lastPart[0];
                                                    let right = lastPart[1];
                                            
                                                    // ✅ Convert ONLY when format is 4-digit / 2-digit
                                                    if (/^\d{4}$/.test(left) && /^\d{2}$/.test(right)) {
                                                        let transformed = `${parts[0]}-${parts[1]}-${right}/${left}`;
                                                        console.log(transformed); // "SI-IP-25/0010"
                                                        $('#txt_interim_real_no').val(transformed);
                                                    } else {
                                                        // ❌ Already correct format like SI-IP-25/0002 → keep original
                                                        $('#txt_interim_real_no').val(original);
                                                    }
                 ...
                 function load_data_to_grid_view_invoice_list()
                 {
                     ...
                     invoice_view_list_table = $('#list_of_invoices').DataTable( {
                            ...
                            "columns": [
                                 ...
                                 { "data": "invoice_date"},
                                //  { "data": "interim_real_no",
                                //       render: function (data, type, row) {
                                //     // data is something like "SI-IP-0010/25"
                                //     let parts = data.split('-');
                                //     if (parts.length === 3) {
                                //         let subParts = parts[2].split('/');
                                //         if (subParts.length === 2) {
                                //             return `${parts[0]}-${parts[1]}-${subParts[1]}/${subParts[0]}`;
                                //         }
                                //     }
                                //     return data; // fallback in case of unexpected format
                                // }
                                //  },
                                
                                 {
                                        ...
                                        render: function (data, type, row) {
                                            // Expected formats:
                                            // Convert: SI-IP-0010/25
                                            // Ignore:  SI-IP-25/0002
                                            ...
                                            if (parts.length === 3) {
                                                ...
                                                if (subParts.length === 2) {
                                                    let left = subParts[0];
                                                    let right = subParts[1];
                                    
                                                    // Convert ONLY if format is 4-digit / 2-digit
                                                    if (left.length === 4 && right.length === 2) {
                                                        return `${parts[0]}-${parts[1]}-${right}/${left}`;
                                                    }
                                                }
                                            }
                                 ...
                                 { "data": "invoice_main_id" ,
                                          ...
                                          render: function ( data, type, rows, meta ) {
                								    ...
                								    if(rows['update_status']=='YES')
                								    {
                								       str_active_status_view = ' <button type="button" class="btn btn-sm primary-gradient mr-2" onclick="openNavR()" id="view_invoice_edit" name="view_invoice_edit" ><i class="material-icons ">mode_edit</i></button>';
                ...
                // 							 },
				   ...
				   function load_data_to_grid_view_invoice_list_between(v_invoice_from_date,v_invoice_to_date,company_id_srch)
                 {
                      invoice_view_list_table.destroy();
                     ...
                     invoice_view_list_table = $('#list_of_invoices').DataTable( {
                             ...
                             "ajax": {
                                 ...
                                 'data': {
                                    ...
                                    v_invoice_company_id:company_id_srch
                                 }
                             },
                             "language": {
                                 "zeroRecords": "No records available",
                ...
                // 							 },
                 ...
                 $('#btn_create_invoice').click(function(){
                  ...
                  $('#btn_search_date').click(function(){
                     ...
                     var company_id_srch = $("#select_company_search").val();
                    //  alert(company_id_srch);
                     load_data_to_grid_view_invoice_list_between(v_invoice_from_date,v_invoice_to_date,company_id_srch);
                 ...
                 $("#txt_end_date").on("change", function() {
                   ...
                   $('#list_of_invoices tbody').on('click', 'td button', function (){
                        ...
                        let original = data.interim_real_no; // "SI-IP-0010/25"
                        // let parts = original.split('-'); // ["SI", "IP", "0010/25"]
                        ...
                        // $("#txt_interim_real_no").val(data.interim_real_no);
                       ...
                       console.log('company_id'+data.company_id);
                             ...
                             if(status=="success")
                                   {
                                       ...
                                       $('#div_select_quotation_combo option').map(function () {
                                        ...
                                        $.post('../controller/invoice/new_invoice_controller.php',{action:'select_total_discount_amount_for_qt',v_quotation_no : data.quotation_reference},function(result,status){
                                         if(status=='success')
                                         {
                                     ...
                                     var lbl_vat_percentage = parseFloat(obj.data[0].tax_content).toLocaleString("en-IN", { minimumFractionDigits: 0, maximumFractionDigits: 0 });
                                      var lbl_vat_amount= parseFloat(obj.data[0].tax_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                      var lbl_gross_amt= parseFloat(obj.data[0].gross_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                      var lbl_disc=parseFloat(obj.data[0].discount_amount).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                      var lbl_net_amt_exvat=parseFloat(obj.data[0].sub_total).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                     ...
                                     // $("#table_gross_value").html(lbl_gross_amt);
								    $("#table_vat_perc").html(lbl_vat_percentage+'%');
								    var table_net_amt=$("#table_net_amount_due").html();
								    var numericValue = Number(table_net_amt.replace(/,/g, ''))
								    var table_tax_amt=parseFloat(numericValue)*parseFloat(obj.data[0].tax_content)/100;
								    var table_tax_amt_for_table=parseFloat(table_tax_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
								    $("#table_tax_value").html(table_tax_amt_for_table);
								    var table_total_amt=parseFloat(numericValue)+parseFloat(table_tax_amt)
								    table_total_amt=parseFloat(table_total_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
								    $("#table_total_amount").html(table_total_amt);
                                         }
                                        });
                                   }
                         }); 
                        ...
                        closeNavR();
                          ...
                          if($(this).attr("name")=='view_invoice_edit')
                         {
                        ...
                        else
                        {
                            ...
                            $("#customradio1").prop("checked", true);
                             ...
                             $('#delivery_note_tbl_div').hide();
                              $('#div_hide').hide();
                            $('#quotation_list_div').show();
                           load_data_to_grid_delivery_note_list_for_intern_edit(data.invoice_number);    
                        }
                  ...
                  $('#list_of_cancel_invoices tbody').on('click', 'td button', function (){
                       ...
                       console.log('company_id'+data.company_id);
                        ...
                        $("#div_select_quotation_combo").load('../controller/delivery_note/delivery_note_controller.php',{action:'select_quotation_list',v_ctrl_name:'select_quotation',v_project_id:data.project_id},function(result,status){
                             if(status=="success")
                                   {
                                     ...
                                     var lbl_vat_percentage = parseFloat(obj.data[0].tax_content).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                      var lbl_vat_amount= parseFloat(obj.data[0].tax_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                      var lbl_gross_amt= parseFloat(obj.data[0].gross_amt).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                                      var lbl_disc=parseFloat(obj.data[0].discount_amount);
                                      var lbl_net_amt_exvat=parseFloat(obj.data[0].sub_total).toLocaleString("en-IN", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
                         ...
                         $('#btn_intern_payment_application' ).hide();
                        // $('#update_invoice_list' ).hide();
                ...
                $('#btn_invoice_print_without_head').click(function(){
                   ...
                   else
                   {
                       ...
                       var v_invoice_status = obj.data[0].invoice_status;	
						   ...
						   {
							   window.open("reports/pdf/print//interim_print.php?invoice_number="+invoice_number+"&x=1","_blank"); 
                 ...
                 $('#btn_invoice_print_with_head').click(function(){
                    ...
                    else
                    {
                       ...
                       {
                          window.open("reports/pdf/print//interim_print.php?invoice_number="+invoice_number+"&x=0","_blank"); 
                 ...
                 $('#btn_view_list_of_invoice').click(function(){
                     $("#select_company_search").val(0).trigger("chosen:updated");
